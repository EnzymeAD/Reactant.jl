...
using Reactant: Reactant, AnyTracedRArray, TracedRArray, TracedRNumber, TracedRInteger
...
__compatible_eltype(::Type{T}, ::Type{<:TracedRNumber{U}}) where {T,U} = traced_number_type(T)
