...
#   argument_lists*** — [num_devices][num_args] MTLBuffer handles (ObjC ids)
#   output_lists*** — [num_devices][num_outputs] MTLBuffer handles to fill
...
function _loaded_exec_execute(
    ...
    # Extract output data from MPSGraph results into MTLBuffer-backed buffer handles
