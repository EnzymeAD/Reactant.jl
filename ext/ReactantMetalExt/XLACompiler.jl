...
function mps_maximum(graph, primary, secondary, name::String)
    obj = @objc [graph::id{Metal.MPSGraphs.MPSGraph} maximumWithPrimaryTensor:primary::id{Metal.MPSGraphs.MPSGraphTensor}
                            secondaryTensor:secondary::id{Metal.MPSGraphs.MPSGraphTensor}
                            name:name::id{NSString}]::id{Metal.MPSGraphs.MPSGraphTensor}
    wrap_tensor(obj)
end

"""Subtraction of two tensors"""
function mps_subtract(graph, primary, secondary, name::String)
    obj = @objc [graph::id{Metal.MPSGraphs.MPSGraph} subtractionWithPrimaryTensor:primary::id{Metal.MPSGraphs.MPSGraphTensor}
                            secondaryTensor:secondary::id{Metal.MPSGraphs.MPSGraphTensor}
                            name:name::id{NSString}]::id{Metal.MPSGraphs.MPSGraphTensor}
    wrap_tensor(obj)
end
...
function mps_divide(graph, primary, secondary, name::String)
    obj = @objc [graph::id{Metal.MPSGraphs.MPSGraph} divisionWithPrimaryTensor:primary::id{Metal.MPSGraphs.MPSGraphTensor}
                            secondaryTensor:secondary::id{Metal.MPSGraphs.MPSGraphTensor}
                            name:name::id{NSString}]::id{Metal.MPSGraphs.MPSGraphTensor}
    wrap_tensor(obj)
end
...
function mps_negate(graph, tensor, name::String)
    obj = @objc [graph::id{Metal.MPSGraphs.MPSGraph} negativeWithTensor:tensor::id{Metal.MPSGraphs.MPSGraphTensor}
                            name:name::id{NSString}]::id{Metal.MPSGraphs.MPSGraphTensor}
    wrap_tensor(obj)
end
...
function mps_exp(graph, tensor, name::String)
    obj = @objc [graph::id{Metal.MPSGraphs.MPSGraph} exponentWithTensor:tensor::id{Metal.MPSGraphs.MPSGraphTensor}
                            name:name::id{NSString}]::id{Metal.MPSGraphs.MPSGraphTensor}
    wrap_tensor(obj)
end
...
function mps_log(graph, tensor, name::String)
    obj = @objc [graph::id{Metal.MPSGraphs.MPSGraph} logarithmWithTensor:tensor::id{Metal.MPSGraphs.MPSGraphTensor}
                            name:name::id{NSString}]::id{Metal.MPSGraphs.MPSGraphTensor}
    wrap_tensor(obj)
end
...
function mps_sqrt(graph, tensor, name::String)
    obj = @objc [graph::id{Metal.MPSGraphs.MPSGraph} squareRootWithTensor:tensor::id{Metal.MPSGraphs.MPSGraphTensor}
                            name:name::id{NSString}]::id{Metal.MPSGraphs.MPSGraphTensor}
    wrap_tensor(obj)
end
...
function mps_rsqrt(graph, tensor, name::String)
    obj = @objc [graph::id{Metal.MPSGraphs.MPSGraph} reciprocalSquareRootWithTensor:tensor::id{Metal.MPSGraphs.MPSGraphTensor}
                            name:name::id{NSString}]::id{Metal.MPSGraphs.MPSGraphTensor}
    wrap_tensor(obj)
end
...
function mps_tanh(graph, tensor, name::String)
    obj = @objc [graph::id{Metal.MPSGraphs.MPSGraph} tanhWithTensor:tensor::id{Metal.MPSGraphs.MPSGraphTensor}
                            name:name::id{NSString}]::id{Metal.MPSGraphs.MPSGraphTensor}
    wrap_tensor(obj)
end
...
function mps_sin(graph, tensor, name::String)
    obj = @objc [graph::id{Metal.MPSGraphs.MPSGraph} sinWithTensor:tensor::id{Metal.MPSGraphs.MPSGraphTensor}
                            name:name::id{NSString}]::id{Metal.MPSGraphs.MPSGraphTensor}
    wrap_tensor(obj)
end
...
function mps_cos(graph, tensor, name::String)
    obj = @objc [graph::id{Metal.MPSGraphs.MPSGraph} cosWithTensor:tensor::id{Metal.MPSGraphs.MPSGraphTensor}
                            name:name::id{NSString}]::id{Metal.MPSGraphs.MPSGraphTensor}
    wrap_tensor(obj)
end
...
function mps_abs(graph, tensor, name::String)
    obj = @objc [graph::id{Metal.MPSGraphs.MPSGraph} absoluteWithTensor:tensor::id{Metal.MPSGraphs.MPSGraphTensor}
                            name:name::id{NSString}]::id{Metal.MPSGraphs.MPSGraphTensor}
    wrap_tensor(obj)
end

"""ReLU activation"""
function mps_relu(graph, tensor, name::String)
    obj = @objc [graph::id{Metal.MPSGraphs.MPSGraph} reLUWithTensor:tensor::id{Metal.MPSGraphs.MPSGraphTensor}
                            name:name::id{NSString}]::id{Metal.MPSGraphs.MPSGraphTensor}
    wrap_tensor(obj)
end

"""Sigmoid activation"""
function mps_sigmoid(graph, tensor, name::String)
    obj = @objc [graph::id{Metal.MPSGraphs.MPSGraph} sigmoidWithTensor:tensor::id{Metal.MPSGraphs.MPSGraphTensor}
                            name:name::id{NSString}]::id{Metal.MPSGraphs.MPSGraphTensor}
    wrap_tensor(obj)
end
...
function mps_reverse(graph, tensor, axes::Vector{Int}, name::String)
    ...
    obj = @objc [graph::id{Metal.MPSGraphs.MPSGraph} reverseTensor:tensor::id{Metal.MPSGraphs.MPSGraphTensor}
...
function mps_reduce_sum(graph, tensor, axes::Vector{Int}, name::String)
    ns_axes = NSArray(Metal.MTL.NSNumber.(axes))
    obj = @objc [graph::id{Metal.MPSGraphs.MPSGraph} reductionSumWithTensor:tensor::id{Metal.MPSGraphs.MPSGraphTensor}
                            axes:ns_axes::id{NSArray}
                            name:name::id{NSString}]::id{Metal.MPSGraphs.MPSGraphTensor}
    wrap_tensor(obj)
end
...
function mps_reduce_max(graph, tensor, axes::Vector{Int}, name::String)
    ns_axes = NSArray(Metal.MTL.NSNumber.(axes))
    obj = @objc [graph::id{Metal.MPSGraphs.MPSGraph} reductionMaximumWithTensor:tensor::id{Metal.MPSGraphs.MPSGraphTensor}
                            axes:ns_axes::id{NSArray}
                            name:name::id{NSString}]::id{Metal.MPSGraphs.MPSGraphTensor}
    wrap_tensor(obj)
end
...
function mps_reshape(graph, tensor, shape, name::String)
    ...
    obj = @objc [graph::id{Metal.MPSGraphs.MPSGraph} reshapeTensor:tensor::id{Metal.MPSGraphs.MPSGraphTensor}
...
function mps_concatenate(graph, tensors::Vector{Metal.MPSGraphs.MPSGraphTensor}, dimension::Int, name::String)
    ns_tensors = NSArray(tensors)
    obj = @objc [graph::id{Metal.MPSGraphs.MPSGraph} concatTensors:ns_tensors::id{NSArray}
...
function mps_convolution2d(graph, input, weights, descriptor, name::String)
    obj = @objc [graph::id{Metal.MPSGraphs.MPSGraph} convolution2DWithSourceTensor:input::id{Metal.MPSGraphs.MPSGraphTensor}
...
function mps_max_pooling2d(graph, input, descriptor, name::String)
    obj = @objc [graph::id{Metal.MPSGraphs.MPSGraph} maxPooling2DWithSourceTensor:input::id{Metal.MPSGraphs.MPSGraphTensor}
...
function mps_avg_pooling2d(graph, input, descriptor, name::String)
    obj = @objc [graph::id{Metal.MPSGraphs.MPSGraph} avgPooling2DWithSourceTensor:input::id{Metal.MPSGraphs.MPSGraphTensor}
                            descriptor:descriptor::id{Metal.MPSGraphs.MPSGraphPooling2DOpDescriptor}
                            name:name::id{NSString}]::id{Metal.MPSGraphs.MPSGraphTensor}
    wrap_tensor(obj)
end
...
function mps_convolution3d(graph, input, weights, descriptor, name::String)
    obj = @objc [graph::id{Metal.MPSGraphs.MPSGraph} convolution3DWithSourceTensor:input::id{Metal.MPSGraphs.MPSGraphTensor}
                            weightsTensor:weights::id{Metal.MPSGraphs.MPSGraphTensor}
...
function mps_create_conv3d_descriptor(; stride_x=1, stride_y=1, stride_z=1,
                                        dilation_x=1, dilation_y=1, dilation_z=1,
                                        groups=1,
    ...
    sx = UInt(stride_x); sy = UInt(stride_y); sz = UInt(stride_z)
    dx = UInt(dilation_x); dy = UInt(dilation_y); dz = UInt(dilation_z)
    g = UInt(groups)
    pl = UInt(padding_left); pr = UInt(padding_right)
    pt = UInt(padding_top); pb = UInt(padding_bottom)
    pf = UInt(padding_front); pk = UInt(padding_back)
    ps = UInt(Metal.MPSGraphs.MPSGraphPaddingStyleExplicit)
    dl = UInt(data_layout)
    wl = UInt(weights_layout)
    desc = @objc [MPSGraphConvolution3DOpDescriptor descriptorWithStrideInX:sx::UInt
                   strideInY:sy::UInt
                   strideInZ:sz::UInt
                   ...
                   dataLayout:dl::UInt
                   weightsLayout:wl::UInt]::id{MPSGraphConvolution3DOpDescriptor}
    return MPSGraphConvolution3DOpDescriptor(desc)
end

"""Create an MPSGraphConvolution2DOpDescriptor via Apple's factory method."""
function mps_create_conv2d_descriptor(; stride_x=1, stride_y=1, dilation_x=1, dilation_y=1,
                                        groups=1, padding_top=0, padding_bottom=0,
                                        padding_left=0, padding_right=0,
    ...
    sx = UInt(stride_x); sy = UInt(stride_y)
    dx = UInt(dilation_x); dy = UInt(dilation_y)
    g = UInt(groups)
    pl = UInt(padding_left); pr = UInt(padding_right)
    pt = UInt(padding_top); pb = UInt(padding_bottom)
    ps = UInt(Metal.MPSGraphs.MPSGraphPaddingStyleExplicit)
    dl = UInt(data_layout)
    wl = UInt(weights_layout)
    desc = @objc [MPSGraphConvolution2DOpDescriptor descriptorWithStrideInX:sx::UInt
                   strideInY:sy::UInt
                   dilationRateInX:dx::UInt
                   dilationRateInY:dy::UInt
                   groups:g::UInt
                   ...
                   paddingStyle:ps::UInt
                   dataLayout:dl::UInt
                   weightsLayout:wl::UInt]::id{MPSGraphConvolution2DOpDescriptor}
    return MPSGraphConvolution2DOpDescriptor(desc)
end

"""Create an MPSGraphPooling2DOpDescriptor via Apple's factory method."""
function mps_create_pooling2d_descriptor(; kernel_w=2, kernel_h=2, stride_x=2, stride_y=2,
                                           dilation_x=1, dilation_y=1,
                                           padding_top=0, padding_bottom=0,
                                           padding_left=0, padding_right=0,
                                           data_layout=Metal.MPSGraphs.MPSGraphTensorNamedDataLayoutNHWC)
    kw = UInt(kernel_w); kh = UInt(kernel_h)
    sx = UInt(stride_x); sy = UInt(stride_y)
    dx = UInt(dilation_x); dy = UInt(dilation_y)
    pl = UInt(padding_left); pr = UInt(padding_right)
    pt = UInt(padding_top); pb = UInt(padding_bottom)
    ps = UInt(Metal.MPSGraphs.MPSGraphPaddingStyleExplicit)
    dl = UInt(data_layout)
    desc = @objc [MPSGraphPooling2DOpDescriptor descriptorWithKernelWidth:kw::UInt
                   ...
                   paddingBottom:pb::UInt
                   paddingStyle:ps::UInt
                   dataLayout:dl::UInt]::id{MPSGraphPooling2DOpDescriptor}
...
function mps_create_pooling4d_descriptor(; kernel_sizes::Vector{Int}, strides::Vector{Int},
    ...
    ps = UInt(Metal.MPSGraphs.MPSGraphPaddingStyleExplicit)
    desc = @objc [MPSGraphPooling4DOpDescriptor descriptorWithKernelSizes:ns_kernels::id{NSArray}
                   strides:ns_strides::id{NSArray}
                   dilationRates:ns_dilations::id{NSArray}
                   paddingValues:ns_padding::id{NSArray}
                   paddingStyle:ps::UInt]::id{MPSGraphPooling4DOpDescriptor}
...
function mps_max_pooling4d(graph, input, descriptor, name::String)
    obj = @objc [graph::id{Metal.MPSGraphs.MPSGraph} maxPooling4DWithSourceTensor:input::id{Metal.MPSGraphs.MPSGraphTensor}
...
function mps_avg_pooling4d(graph, input, descriptor, name::String)
    obj = @objc [graph::id{Metal.MPSGraphs.MPSGraph} avgPooling4DWithSourceTensor:input::id{Metal.MPSGraphs.MPSGraphTensor}
                            descriptor:descriptor::id{Metal.MPSGraphs.MPSGraphPooling4DOpDescriptor}
                            name:name::id{NSString}]::id{Metal.MPSGraphs.MPSGraphTensor}
    wrap_tensor(obj)
end
...
function mps_scatter_nd(graph, data, updates, indices, batch_dims::Int, mode::Int, name::String)
    obj = @objc [graph::id{Metal.MPSGraphs.MPSGraph} scatterNDWithDataTensor:data::id{Metal.MPSGraphs.MPSGraphTensor}
...
function mps_slice_dim(graph, tensor, dim::Int, start::Int, len::Int, name::String)
    obj = @objc [graph::id{Metal.MPSGraphs.MPSGraph} sliceTensor:tensor::id{Metal.MPSGraphs.MPSGraphTensor}
