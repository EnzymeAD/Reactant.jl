  ...
  @testset "trace_type" begin
    @testset "mode = ConcreteToTraced" begin
      @testset "$origty" for (origty, targetty, targettynum) in [
        ...
        (
          Bijection{Symbol,Int,Dict{Symbol,Int},Dict{Int,Symbol}},
          Bijection{Symbol,Int,Dict{Symbol,Int},Dict{Int,Symbol}},
          Bijection{Symbol,Int,Dict{Symbol,Int},Dict{Int,Symbol}}
        ),
        (
          Bijection{Symbol,Int,Dict{Symbol,Int},IdDict{Int,Symbol}},
          Bijection{Symbol,Int,Dict{Symbol,Int},IdDict{Int,Symbol}},
          Bijection{Symbol,Int,Dict{Symbol,Int},IdDict{Int,Symbol}}
        ),
        (
          Bijection{Symbol,Int},
          Bijection{Symbol,Int},
          Bijection{Symbol,Int}
        ),
        (
          Bijection{Int,ConcreteRArray{Float64,0},Dict{Int,ConcreteRArray{Float64,0}},Dict{ConcreteRArray{Float64,0},Int}},
          Bijection{Int,TracedRArray{Float64,0},Dict{Int,TracedRArray{Float64,0}},Dict{TracedRArray{Float64,0},Int}},
          Bijection{Int,TracedRArray{Float64,0},Dict{Int,TracedRArray{Float64,0}},Dict{TracedRArray{Float64,0},Int}}
        ),
        (
          Bijection{Int,ConcreteRArray{Float64,0},Dict{Int,ConcreteRArray{Float64,0}},IdDict{ConcreteRArray{Float64,0},Int}},
          Bijection{Int,TracedRArray{Float64,0},Dict{Int,TracedRArray{Float64,0}},IdDict{TracedRArray{Float64,0},Int}},
          Bijection{Int,TracedRArray{Float64,0},Dict{Int,TracedRArray{Float64,0}},IdDict{TracedRArray{Float64,0},Int}}
        ),
        (
          Bijection{Int,ConcreteRArray{Float64,0}},
