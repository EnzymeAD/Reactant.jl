...
Base.@nospecializeinfer function Reactant.traced_type_inner(
    ...
    FT2 = Reactant.traced_type_inner(FT, seen, mode, track_numbers, ndevices_val, runtime)
    AT2 = Reactant.traced_type_inner(AT, seen, mode, track_numbers, ndevices_val, runtime)
