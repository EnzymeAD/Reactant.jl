...
%1094 = stablehlo.constant dense<0.0> : tensor<f64>
    ...
    cond {
      ...
      cond {
        ...
        %1982 = stablehlo.select %c_63, %c_63, %c_63 : tensor<i1>, tensor<i1>
        stablehlo.return %1968#0, %1968#1, %1968#2, %1968#3, %1968#4, %1968#5, %1968#6, %1968#7, %1968#8, %1968#9, %1968#10, %1968#11, %1982, %1968#12, %1968#13, %1968#14, %1968#15, %1932, %iterArg_110, %iterArg_111, %1971 : tensor<1x2xf64>, tensor<1x2xf64>, tensor<1x2xf64>, tensor<1x2xf64>, tensor<1x2xf64>, tensor<1x2xf64>, tensor<1x2xf64>, tensor<1x2xf64>, tensor<f64>, tensor<f64>, tensor<i64>, tensor<f64>, tensor<i1>, tensor<i1>, tensor<f64>, tensor<i64>, tensor<1x2xf64>, tensor<2xui64>, tensor<3x2xf64>, tensor<3x2xf64>, tensor<i64>
      }
