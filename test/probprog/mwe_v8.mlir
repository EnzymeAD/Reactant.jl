...
func.func @main(%arg0: tensor<2xui64> {tf.aliasing_output = 1 : i32}, %arg1: tensor<2x1xf64>, %arg2: tensor<f64>, %arg3: tensor<2x2xf64>) -> (tensor<2x1xf64>, tensor<2xui64>) {
    ...
    cond {
      ...
      cond {
        ...
        // rng_bit_generator consuming key2 (NO stablehlo.if)
        %rng_mid, %bits_mid = stablehlo.rng_bit_generator %key2, algorithm = DEFAULT : (tensor<2xui64>) -> (tensor<2xui64>, tensor<ui64>)

        %new_idx = stablehlo.add %mA15, %c_1i64 : tensor<i64>
        %new_cnt = stablehlo.add %mA20, %c_1i64 : tensor<i64>
        stablehlo.return %mA0, %mA1, %mA2, %mA3, %mA4, %mA5, %mA6, %mA7, %mA8, %mA9, %mA10, %mA11, %c_false, %mA13, %mA14, %new_idx, %mA16, %key1, %mA18, %mA19, %new_cnt : tensor<1x2xf64>, tensor<1x2xf64>, tensor<1x2xf64>, tensor<1x2xf64>, tensor<1x2xf64>, tensor<1x2xf64>, tensor<1x2xf64>, tensor<1x2xf64>, tensor<f64>, tensor<f64>, tensor<i64>, tensor<f64>, tensor<i1>, tensor<i1>, tensor<f64>, tensor<i64>, tensor<1x2xf64>, tensor<2xui64>, tensor<3x2xf64>, tensor<3x2xf64>, tensor<i64>
      }
