...
class LogisticRegression(BaseImpulseImplementation):
    def __init__(self, n: int, k: int, alpha_scale: float, beta_scale: float, beta_loc: float) -> None:
        self.n = n
        self.k = k
    ...
    def julia_model_path(self) -> str:
        return "standard/logistic_regression"
