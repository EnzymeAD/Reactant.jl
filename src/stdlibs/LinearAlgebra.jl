...
function __init__()
    if Reactant_jll.is_available()
        ...
        for (cname, enzymexla_name) in [
            ...
            (@blasfunc(LAPACKE_sgetrf), :enzymexla_lapacke_sgetrf_),
            (@blasfunc(LAPACKE_dgetrf), :enzymexla_lapacke_dgetrf_),
            (@blasfunc(LAPACKE_cgetrf), :enzymexla_lapacke_cgetrf_),
            (@blasfunc(LAPACKE_zgetrf), :enzymexla_lapacke_zgetrf_),
            (@blasfunc(LAPACKE_sgetrf_work), :enzymexla_lapacke_sgetrf_work_),
            (@blasfunc(LAPACKE_dgetrf_work), :enzymexla_lapacke_dgetrf_work_),
            (@blasfunc(LAPACKE_cgetrf_work), :enzymexla_lapacke_cgetrf_work_),
            (@blasfunc(LAPACKE_zgetrf_work), :enzymexla_lapacke_zgetrf_work_),
            # geqrf
            ...
            # ormqr
            (@blasfunc(sormqr_), :enzymexla_lapack_sormqr_),
            (@blasfunc(dormqr_), :enzymexla_lapack_dormqr_),
            (@blasfunc(LAPACKE_sormqr), :enzymexla_lapacke_sormqr_),
            (@blasfunc(LAPACKE_dormqr), :enzymexla_lapacke_dormqr_),
            (@blasfunc(LAPACKE_sormqr_work), :enzymexla_lapacke_sormqr_work_),
            (@blasfunc(LAPACKE_dormqr_work), :enzymexla_lapacke_dormqr_work_),
            # unmqr
            (@blasfunc(cunmqr_), :enzymexla_lapack_cunmqr_),
            (@blasfunc(zunmqr_), :enzymexla_lapack_zunmqr_),
            (@blasfunc(LAPACKE_cunmqr), :enzymexla_lapacke_cunmqr_),
            (@blasfunc(LAPACKE_zunmqr), :enzymexla_lapacke_zunmqr_),
            (@blasfunc(LAPACKE_cunmqr_work), :enzymexla_lapacke_cunmqr_work_),
            (@blasfunc(LAPACKE_zunmqr_work), :enzymexla_lapacke_zunmqr_work_),
            # gemqrt
            (@blasfunc(sgemqrt_), :enzymexla_lapack_sgemqrt_),
            (@blasfunc(dgemqrt_), :enzymexla_lapack_dgemqrt_),
            (@blasfunc(cgemqrt_), :enzymexla_lapack_cgemqrt_),
            (@blasfunc(zgemqrt_), :enzymexla_lapack_zgemqrt_),
            (@blasfunc(LAPACKE_sgemqrt), :enzymexla_lapacke_sgemqrt_),
            (@blasfunc(LAPACKE_dgemqrt), :enzymexla_lapacke_dgemqrt_),
            (@blasfunc(LAPACKE_cgemqrt), :enzymexla_lapacke_cgemqrt_),
            (@blasfunc(LAPACKE_zgemqrt), :enzymexla_lapacke_zgemqrt_),
            (@blasfunc(LAPACKE_sgemqrt_work), :enzymexla_lapacke_sgemqrt_work_),
            (@blasfunc(LAPACKE_dgemqrt_work), :enzymexla_lapacke_dgemqrt_work_),
            (@blasfunc(LAPACKE_cgemqrt_work), :enzymexla_lapacke_cgemqrt_work_),
            (@blasfunc(LAPACKE_zgemqrt_work), :enzymexla_lapacke_zgemqrt_work_),
            # gesvd
