...
function __init__()
    if Reactant_jll.is_available()
        ...
        for (cname, enzymexla_name) in [
            ...
            # geqrt3
            (@blasfunc(sgeqrt3_), :enzymexla_lapack_sgeqrt3_),
            (@blasfunc(dgeqrt3_), :enzymexla_lapack_dgeqrt3_),
            (@blasfunc(cgeqrt3_), :enzymexla_lapack_cgeqrt3_),
            (@blasfunc(zgeqrt3_), :enzymexla_lapack_zgeqrt3_),
            (@blasfunc(LAPACKE_sgeqrt3), :enzymexla_lapacke_sgeqrt3_),
            (@blasfunc(LAPACKE_dgeqrt3), :enzymexla_lapacke_dgeqrt3_),
            (@blasfunc(LAPACKE_cgeqrt3), :enzymexla_lapacke_cgeqrt3_),
            (@blasfunc(LAPACKE_zgeqrt3), :enzymexla_lapacke_zgeqrt3_),
            (@blasfunc(LAPACKE_sgeqrt3_work), :enzymexla_lapacke_sgeqrt3_work_),
            (@blasfunc(LAPACKE_dgeqrt3_work), :enzymexla_lapacke_dgeqrt3_work_),
            (@blasfunc(LAPACKE_cgeqrt3_work), :enzymexla_lapacke_cgeqrt3_work_),
            (@blasfunc(LAPACKE_zgeqrt3_work), :enzymexla_lapacke_zgeqrt3_work_),
            # orgqr
