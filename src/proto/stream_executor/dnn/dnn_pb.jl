# Autogenerated using ProtoBuf.jl v1.2.0 on 2026-01-09T22:00:52.356
# original file: /mnt/software/lux/Reactant.jl/deps/ReactantExtra/proto_staging/xla/tsl/protobuf/dnn.proto (proto3 syntax)
...
abstract type var"##Abstract#TensorDescriptorProto" end
abstract type var"##Abstract#AlgorithmConfigProto" end
...
struct TensorDescriptorProto{T1<:Union{Nothing,OneOf{<:Union{DataLayout.T,FilterLayout.T}}}}
    dimensions::Vector{Int64}
    data_type::var"#DataType".T
    layout_oneof::T1
end
TensorDescriptorProto(;dimensions = Vector{Int64}(), data_type = var"#DataType".kFloat, layout_oneof = nothing) = TensorDescriptorProto{typeof(layout_oneof)}(dimensions, data_type, layout_oneof)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:TensorDescriptorProto})
    ...
    return TensorDescriptorProto{typeof(layout_oneof)}(dimensions[], data_type, layout_oneof)
end
...
struct AlgorithmConfigProto{T1<:Union{Nothing,OneOf{AlgorithmProto}},T2<:Union{Nothing,OneOf{AlgorithmProto}},T3<:Union{Nothing,OneOf{Int64}}}
    optional_algorithm::T1
    optional_algorithm_no_scratch::T2
    optional_scratch_size::T3
end
AlgorithmConfigProto(;optional_algorithm = nothing, optional_algorithm_no_scratch = nothing, optional_scratch_size = nothing) = AlgorithmConfigProto{typeof(optional_algorithm),typeof(optional_algorithm_no_scratch),typeof(optional_scratch_size)}(optional_algorithm, optional_algorithm_no_scratch, optional_scratch_size)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:AlgorithmConfigProto})
    ...
    return AlgorithmConfigProto{typeof(optional_algorithm),typeof(optional_algorithm_no_scratch),typeof(optional_scratch_size)}(optional_algorithm, optional_algorithm_no_scratch, optional_scratch_size)
end
