...
struct DebugOptions
    ...
    xla_gpu_experimental_ragged_all_to_all_use_barrier::Bool
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:DebugOptions}, _endpos::Int=0, _group::Bool=false)
    ...
    while !PB.message_done(d, _endpos, _group)
        ...
        elseif field_number == 450
            xla_gpu_experimental_ragged_all_to_all_use_barrier = PB.decode(d, Bool)
...
function PB.encode(e::PB.AbstractProtoEncoder, x::DebugOptions)
    ...
    x.xla_gpu_experimental_ragged_all_to_all_use_barrier != false && PB.encode(e, 450, x.xla_gpu_experimental_ragged_all_to_all_use_barrier)
...
function PB._encoded_size(x::DebugOptions)
    ...
    x.xla_gpu_experimental_ragged_all_to_all_use_barrier != false && (encoded_size += PB._encoded_size(x.xla_gpu_experimental_ragged_all_to_all_use_barrier, 450))
