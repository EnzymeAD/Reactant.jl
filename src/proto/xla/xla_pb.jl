...
export var"ScheduleProto.SchedulerStatisticsProto"
export var"DebugOptions.CommandBufferUpdateMode", var"DebugOptions.CollectivesMode"
export var"HloModuleConfigProto.BoolList", var"DebugOptions.StepMarkerLocation"
export var"DebugOptions.CollectiveOpType", var"DebugOptions.ShapeChecks"
export var"DebugOptions.XnnGraphFusionMode", var"DebugOptions.CpuOptPreset"
export var"DebugOptions.DevicelessCubMode", GpuCompilationEnvironment
export var"ScheduleConfigProto.Instruction", var"DebugOptions.WhileLoopUnrolling"
export NodeShardingConfigProto, IntRangeInclusive, var"DebugOptions.CpuSchedulerType"
...
@enumx var"DebugOptions.CommandBufferUpdateMode" ALWAYS_UPDATE=0 NEVER_UPDATE=1 CAPTURE_CMD_NEVER_UPDATE=2
...
@enumx var"DebugOptions.CommandBufferCmdType" INVALID=0 FUSION=1 CUBLAS=2 CUDNN=3 COLLECTIVES=4 CONDITIONAL=5 WHILE=6 CUSTOM_CALL=7 CUBLASLT=8 DYNAMIC_SLICE_FUSION=9 DYNAMIC_SLICE_COPY_FUSION=10 CONVOLUTION=11
