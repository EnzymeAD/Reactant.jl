...
export var"DebugOptions.CpuSchedulerType", CompilationEnvironmentsProto
...
struct DebugOptions
    ...
    xla_gpu_experimental_move_gemm_conv_autotuner::Bool
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:DebugOptions}, _endpos::Int=0, _group::Bool=false)
    ...
    xla_gpu_experimental_move_gemm_conv_autotuner = false
    ...
    while !PB.message_done(d, _endpos, _group)
        ...
        elseif field_number == 477
            xla_gpu_experimental_move_gemm_conv_autotuner = PB.decode(d, Bool)
...
function PB.encode(e::PB.AbstractProtoEncoder, x::DebugOptions)
    ...
    x.xla_gpu_experimental_move_gemm_conv_autotuner != false && PB.encode(e, 477, x.xla_gpu_experimental_move_gemm_conv_autotuner)
...
function PB._encoded_size(x::DebugOptions)
    ...
    x.xla_gpu_experimental_move_gemm_conv_autotuner != false && (encoded_size += PB._encoded_size(x.xla_gpu_experimental_move_gemm_conv_autotuner, 477))
