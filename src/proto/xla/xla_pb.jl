...
struct DebugOptions
    ...
    xla_gpu_match_tpu_precision::Bool
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:DebugOptions}, _endpos::Int=0, _group::Bool=false)
    ...
    xla_gpu_match_tpu_precision = false
    ...
    while !PB.message_done(d, _endpos, _group)
        ...
        elseif field_number == 441
            xla_gpu_match_tpu_precision = PB.decode(d, Bool)
...
function PB.encode(e::PB.AbstractProtoEncoder, x::DebugOptions)
    ...
    x.xla_gpu_match_tpu_precision != false && PB.encode(e, 441, x.xla_gpu_match_tpu_precision)
...
function PB._encoded_size(x::DebugOptions)
    ...
    x.xla_gpu_match_tpu_precision != false && (encoded_size += PB._encoded_size(x.xla_gpu_match_tpu_precision, 441))
