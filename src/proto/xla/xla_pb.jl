...
export var"DebugOptions.CpuOptPreset", GpuCompilationEnvironment
export var"ScheduleConfigProto.Instruction", NodeShardingConfigProto
export var"DebugOptions.PGLEStrictnessLevel"
...
export var"DebugOptions.CpuSchedulerType", var"DebugOptions.CommandBufferCmdType"
export var"DebugOptions.CollectiveFilter", ScheduleConfigProto, ShardingConfigProto
export ThunkBufferDebugFilter, var"HloModuleConfigProto.Int64ListList"
export var"ScheduleProto.ComputationScheduleProto", DebugOptions, ScheduleProto
...
@enumx var"DebugOptions.CommandBufferUpdateMode" ALWAYS_UPDATE=0 SKIP_TEMP=1
...
struct DebugOptions
    ...
    xla_experimental_enable_same_shape_multi_output_fusion::Bool
    ...
    xla_gpu_experimental_ragged_all_to_all_zero_copy::Bool
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:DebugOptions}, _endpos::Int=0, _group::Bool=false)
    ...
    xla_experimental_enable_same_shape_multi_output_fusion = false
    ...
    xla_gpu_experimental_ragged_all_to_all_zero_copy = false
    ...
    while !PB.message_done(d, _endpos, _group)
        ...
        elseif field_number == 515
            xla_experimental_enable_same_shape_multi_output_fusion = PB.decode(d, Bool)
        ...
        elseif field_number == 480
            xla_gpu_experimental_ragged_all_to_all_zero_copy = PB.decode(d, Bool)
...
function PB.encode(e::PB.AbstractProtoEncoder, x::DebugOptions)
    ...
    x.xla_experimental_enable_same_shape_multi_output_fusion != false && PB.encode(e, 515, x.xla_experimental_enable_same_shape_multi_output_fusion)
    ...
    x.xla_gpu_experimental_ragged_all_to_all_zero_copy != false && PB.encode(e, 480, x.xla_gpu_experimental_ragged_all_to_all_zero_copy)
...
function PB._encoded_size(x::DebugOptions)
    ...
    x.xla_experimental_enable_same_shape_multi_output_fusion != false && (encoded_size += PB._encoded_size(x.xla_experimental_enable_same_shape_multi_output_fusion, 515))
    ...
    x.xla_gpu_experimental_ragged_all_to_all_zero_copy != false && (encoded_size += PB._encoded_size(x.xla_gpu_experimental_ragged_all_to_all_zero_copy, 480))
