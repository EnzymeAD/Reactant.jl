...
struct DebugOptions
    ...
    xla_gpu_unsupported_disable_nested_gemm_fusions::Bool
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:DebugOptions}, _endpos::Int=0, _group::Bool=false)
    ...
    xla_gpu_unsupported_disable_nested_gemm_fusions = false
    ...
    while !PB.message_done(d, _endpos, _group)
        ...
        elseif field_number == 443
            xla_gpu_unsupported_disable_nested_gemm_fusions = PB.decode(d, Bool)
...
function PB.encode(e::PB.AbstractProtoEncoder, x::DebugOptions)
    ...
    x.xla_gpu_unsupported_disable_nested_gemm_fusions != false && PB.encode(e, 443, x.xla_gpu_unsupported_disable_nested_gemm_fusions)
...
function PB._encoded_size(x::DebugOptions)
    ...
    x.xla_gpu_unsupported_disable_nested_gemm_fusions != false && (encoded_size += PB._encoded_size(x.xla_gpu_unsupported_disable_nested_gemm_fusions, 443))
