...
struct DebugOptions
    ...
    xla_gpu_enable_command_buffer_va_remapping::Bool
    ...
    xla_gpu_experimental_enable_onehot_rewriter::Bool
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:DebugOptions}, _endpos::Int=0, _group::Bool=false)
    ...
    xla_gpu_enable_command_buffer_va_remapping = false
    ...
    while !PB.message_done(d, _endpos, _group)
        ...
        elseif field_number == 464
            xla_gpu_enable_command_buffer_va_remapping = PB.decode(d, Bool)
        ...
        elseif field_number == 458
            xla_gpu_experimental_enable_onehot_rewriter = PB.decode(d, Bool)
...
function PB.encode(e::PB.AbstractProtoEncoder, x::DebugOptions)
    ...
    x.xla_gpu_enable_command_buffer_va_remapping != false && PB.encode(e, 464, x.xla_gpu_enable_command_buffer_va_remapping)
    ...
    x.xla_gpu_experimental_enable_onehot_rewriter != false && PB.encode(e, 458, x.xla_gpu_experimental_enable_onehot_rewriter)
...
function PB._encoded_size(x::DebugOptions)
    ...
    x.xla_gpu_enable_command_buffer_va_remapping != false && (encoded_size += PB._encoded_size(x.xla_gpu_enable_command_buffer_va_remapping, 464))
    ...
    x.xla_gpu_experimental_enable_onehot_rewriter != false && (encoded_size += PB._encoded_size(x.xla_gpu_experimental_enable_onehot_rewriter, 458))
