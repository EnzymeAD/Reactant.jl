# Autogenerated using ProtoBuf.jl v1.2.0 on 2026-01-09T22:00:52.706
# original file: /mnt/software/lux/Reactant.jl/deps/ReactantExtra/proto_staging/xla/autotuning.proto (proto3 syntax)
...
abstract type var"##Abstract#AutotuneResult.FailureResult" end
abstract type var"##Abstract#AutotuneResult" end
...
struct var"AutotuneResult.FailureResult"{T1<:Union{Nothing,OneOf{<:Union{var"AutotuneResult.ConvKey",var"AutotuneResult.GemmKey",var"AutotuneResult.CudaConvPlanKey",stream_executor.dnn.AlgorithmProto}}}}
    kind::var"AutotuneResult.FailureKind".T
    msg::String
    key::T1
    buffer_address::Int64
end
var"AutotuneResult.FailureResult"(;kind = var"AutotuneResult.FailureKind".UNKNOWN, msg = "", key = nothing, buffer_address = zero(Int64)) = var"AutotuneResult.FailureResult"{typeof(key)}(kind, msg, key, buffer_address)
PB.oneof_field_types(::Type{var"AutotuneResult.FailureResult"}) = (;
    key = (;reference_conv=var"AutotuneResult.ConvKey", reference_gemm=var"AutotuneResult.GemmKey", reference_cuda_conv_plan=var"AutotuneResult.CudaConvPlanKey", reference_algorithm=stream_executor.dnn.AlgorithmProto),
)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:var"AutotuneResult.FailureResult"})
    ...
    while !PB.message_done(d)
        ...
        elseif field_number == 15
            key = OneOf(:reference_algorithm, PB.decode(d, Ref{stream_executor.dnn.AlgorithmProto}))
    ...
    return var"AutotuneResult.FailureResult"{typeof(key)}(kind, msg, key, buffer_address)
end
...
function PB.encode(e::PB.AbstractProtoEncoder, x::var"AutotuneResult.FailureResult")
    ...
    elseif x.key.name === :reference_algorithm
        PB.encode(e, 15, x.key[]::stream_executor.dnn.AlgorithmProto)
    end
...
function PB._encoded_size(x::var"AutotuneResult.FailureResult")
    ...
    elseif x.key.name === :reference_algorithm
        encoded_size += PB._encoded_size(x.key[]::stream_executor.dnn.AlgorithmProto, 15)
    end
    x.buffer_address != zero(Int64) && (encoded_size += PB._encoded_size(x.buffer_address, 13))
    return encoded_size
end

struct AutotuneResult{T1<:Union{Nothing,OneOf{<:Union{var"AutotuneResult.ConvKey",var"AutotuneResult.GemmKey",var"AutotuneResult.TritonGemmKey",var"AutotuneResult.CudaConvPlanKey",var"AutotuneResult.CustomKernelFusionKey",stream_executor.dnn.AlgorithmProto,var"AutotuneResult.BackendConfigKey"}}}}
    scratch_bytes::Int64
    run_time::Union{Nothing,google.protobuf.Duration}
    failure::Union{Nothing,var"AutotuneResult.FailureResult"}
    key::T1
end
AutotuneResult(;scratch_bytes = zero(Int64), run_time = nothing, failure = nothing, key = nothing) = AutotuneResult{typeof(key)}(scratch_bytes, run_time, failure, key)
PB.oneof_field_types(::Type{AutotuneResult}) = (;
    key = (;conv=var"AutotuneResult.ConvKey", gemm=var"AutotuneResult.GemmKey", triton=var"AutotuneResult.TritonGemmKey", cuda_conv_plan=var"AutotuneResult.CudaConvPlanKey", custom_kernel_fusion=var"AutotuneResult.CustomKernelFusionKey", algorithm=stream_executor.dnn.AlgorithmProto, other=var"AutotuneResult.BackendConfigKey"),
)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:AutotuneResult})
    ...
    while !PB.message_done(d)
        ...
        elseif field_number == 16
            key = OneOf(:algorithm, PB.decode(d, Ref{stream_executor.dnn.AlgorithmProto}))
    ...
    return AutotuneResult{typeof(key)}(scratch_bytes, run_time[], failure[], key)
end
...
function PB.encode(e::PB.AbstractProtoEncoder, x::AutotuneResult)
    ...
    elseif x.key.name === :algorithm
        PB.encode(e, 16, x.key[]::stream_executor.dnn.AlgorithmProto)
...
function PB._encoded_size(x::AutotuneResult)
    ...
    elseif x.key.name === :algorithm
        encoded_size += PB._encoded_size(x.key[]::stream_executor.dnn.AlgorithmProto, 16)
    elseif x.key.name === :other
