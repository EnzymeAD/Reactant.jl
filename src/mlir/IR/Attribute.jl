...
function Attribute(attrs::Vector{Attribute}; context::Context=context())
    return Attribute(API.mlirArrayAttrGet(context, length(attrs), pointer(attrs)))
end
