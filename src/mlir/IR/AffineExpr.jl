...
"""
isfunctionofdimexpr(expr::AffineExpr, position) = API.mlirAffineExprIsFunctionOfDim(expr,
                                                                                    position)
...
"""
AffineDimensionExpr(position; context::Context=context()) = AffineExpr(API.mlirAffineDimExprGet(context,
                                                                                                position))
...
"""
SymbolExpr(position; context::Context=context()) = AffineExpr(API.mlirAffineSymbolExprGet(context,
                                                                                          position))
...
"""
ConstantExpr(constant; context::Context=context()) = AffineExpr(API.mlirAffineConstantExprGet(context,
                                                                                              constant))
...
"""
Base.div(lhs::AffineExpr, rhs::AffineExpr) = AffineExpr(API.mlirAffineFloorDivExprGet(lhs,
                                                                                      rhs))
...
"""
Base.cld(lhs::AffineExpr, rhs::AffineExpr) = AffineExpr(API.mlirAffineCeilDivExprGet(lhs,
                                                                                     rhs))
