...
function br(
    ...
    loop_annotation::Union{Any,Nothing}=nothing,
    dest::Block,
    location::Location=Location(),
)
    op_ty_results = IR.Type[]
...
function call(
    ...
    var_callee_type::Union{Any,Nothing}=nothing,
    callee::Union{IR.FlatSymbol,Nothing}=nothing,
    fastmathFlags::Union{FastmathFlags.T,Nothing}=nothing,
    branch_weights::Union{Vector{Int32},Nothing}=nothing,
    CConv::Union{Any,Nothing}=nothing,
    TailCallKind::Union{Any,Nothing}=nothing,
    memory_effects::Union{Any,Nothing}=nothing,
...
function mlir_global(;
    ...
    comdat::Union{Any,Nothing}=nothing,
...
function func(;
    ...
    function_type::Any,
    linkage::Union{Any,Nothing}=nothing,
    dso_local::Union{Bool,Nothing}=nothing,
    CConv::Union{Any,Nothing}=nothing,
    comdat::Union{Any,Nothing}=nothing,
    convergent::Union{Bool,Nothing}=nothing,
    ...
    unnamed_addr::Union{UnnamedAddr.T,Nothing}=nothing,
    alignment::Union{Int64,Nothing}=nothing,
    vscale_range::Union{Any,Nothing}=nothing,
    frame_pointer::Union{Any,Nothing}=nothing,
    target_cpu::Union{String,Nothing}=nothing,
    tune_cpu::Union{String,Nothing}=nothing,
    target_features::Union{Any,Nothing}=nothing,
    ...
    vec_type_hint::Union{Any,Nothing}=nothing,
