...
function kernel_call(gridx::Value, gridy::Value, gridz::Value, blockx::Value, blocky::Value, blockz::Value, shmem::Value, inputs::Vector{Value}; result::Union{Vector{IR.Type}, Tuple{Vararg{IR.Type}}}, fn::IR.FlatSymbol, backend_config::Union{String, Nothing}=nothing, operand_layouts::Union{IR.Attribute, Nothing}=nothing, result_layouts::Union{IR.Attribute, Nothing}=nothing, output_operand_aliases::Union{Vector{Attribute}, Nothing}=nothing, location=Location())
