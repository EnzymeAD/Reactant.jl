...
function all_gather_v1(operand::Value; result::IR.Type, all_gather_dim::Attribute, replica_groups::Attribute, channel_id::Attribute, use_global_device_ids::Attribute, location=Location())
    op_ty_results = IR.Type[result, ]
    operands = Value[operand, ]
    owned_regions = Region[]
    successors = Block[]
...
function all_gather_v2(operands::Vector{Value}; results::Tuple{Vararg{IR.Type}}, all_gather_dim::Attribute, replica_groups::Attribute, channel_id::Attribute, use_global_device_ids::Attribute, location=Location())
...
function all_reduce_v1(operand::Value; result::IR.Type, replica_groups::Attribute, channel_id::Attribute, use_global_device_ids::Attribute, computation::Region, location=Location())
    op_ty_results = IR.Type[result, ]
    operands = Value[operand, ]
...
function all_reduce_v2(operands::Vector{Value}; results::Tuple{Vararg{IR.Type}}, replica_groups::Attribute, channel_id::Attribute, use_global_device_ids::Attribute, computation::Region, location=Location())
    op_ty_results = IR.Type[results..., ]
    operands = Value[operands..., ]
    owned_regions = Region[computation, ]
    successors = Block[]
...
function all_to_all_v1(operand::Value; result::IR.Type, split_dimension::Attribute, concat_dimension::Attribute, split_count::Attribute, replica_groups::Attribute, channel_id::Attribute, location=Location())
    op_ty_results = IR.Type[result, ]
    operands = Value[operand, ]
    owned_regions = Region[]
    successors = Block[]
...
function all_to_all_v2(operands::Vector{Value}; results::Tuple{Vararg{IR.Type}}, split_dimension::Attribute, concat_dimension::Attribute, split_count::Attribute, replica_groups::Attribute, channel_id::Attribute, location=Location())
    op_ty_results = IR.Type[results..., ]
    operands = Value[operands..., ]
    owned_regions = Region[]
    successors = Block[]
...
function batch_norm_grad_v1(operand::Value, scale::Value, mean::Value, variance::Value, grad_output::Value; grad_operand::IR.Type, grad_scale::IR.Type, grad_offset::IR.Type, epsilon::Attribute, feature_index::Attribute, location=Location())
...
function batch_norm_inference_v1(operand::Value, scale::Value, offset::Value, mean::Value, variance::Value; result::IR.Type, epsilon::Attribute, feature_index::Attribute, location=Location())
    op_ty_results = IR.Type[result, ]
...
function batch_norm_training_v1(operand::Value, scale::Value, offset::Value; output::IR.Type, batch_mean::IR.Type, batch_var::IR.Type, epsilon::Attribute, feature_index::Attribute, location=Location())
...
function broadcast_in_dim_v1(operand::Value; result::IR.Type, broadcast_dimensions::Attribute, location=Location())
    op_ty_results = IR.Type[result, ]
    operands = Value[operand, ]
    owned_regions = Region[]
    successors = Block[]
...
function broadcast_v1(operand::Value; result::IR.Type, broadcast_sizes::Attribute, location=Location())
    op_ty_results = IR.Type[result, ]
    operands = Value[operand, ]
    owned_regions = Region[]
    successors = Block[]
...
function call_v1(operands::Vector{Value}; results::Tuple{Vararg{IR.Type}}, callee::Attribute, location=Location())
    op_ty_results = IR.Type[results..., ]
    operands = Value[operands..., ]
    owned_regions = Region[]
    successors = Block[]
...
function case_v1(index::Value; results::Tuple{Vararg{IR.Type}}, branches::Vector{Region}, location=Location())
    op_ty_results = IR.Type[results..., ]
...
function collective_broadcast_v1(operand::Value; result::IR.Type, replica_groups::Attribute, channel_id::Attribute, location=Location())
    op_ty_results = IR.Type[result, ]
    operands = Value[operand, ]
    owned_regions = Region[]
    successors = Block[]
...
function collective_permute_v1(operand::Value; result::IR.Type, source_target_pairs::Attribute, channel_id::Attribute, location=Location())
    op_ty_results = IR.Type[result, ]
    operands = Value[operand, ]
    owned_regions = Region[]
    successors = Block[]
...
function compare_v1(lhs::Value, rhs::Value; result::IR.Type, comparison_direction::Attribute, compare_type::Attribute, location=Location())
    op_ty_results = IR.Type[result, ]
    operands = Value[lhs, rhs, ]
    owned_regions = Region[]
    successors = Block[]
...
function composite_v1(inputs::Vector{Value}; results::Tuple{Vararg{IR.Type}}, name::Attribute, composite_attributes::Attribute, decomposition::Attribute, version::Attribute, location=Location())
    op_ty_results = IR.Type[results..., ]
    operands = Value[inputs..., ]
    owned_regions = Region[]
    successors = Block[]
...
function concatenate_v1(inputs::Vector{Value}; result::IR.Type, dimension::Attribute, location=Location())
    op_ty_results = IR.Type[result, ]
    operands = Value[inputs..., ]
    owned_regions = Region[]
    successors = Block[]
...
function convolution_v1(lhs::Value, rhs::Value; result::IR.Type, window_strides::Attribute, padding::Attribute, lhs_dilation::Attribute, rhs_dilation::Attribute, window_reversal::Attribute, input_batch_dimension::Attribute, input_feature_dimension::Attribute, input_spatial_dimensions::Attribute, kernel_input_feature_dimension::Attribute, kernel_output_feature_dimension::Attribute, kernel_spatial_dimensions::Attribute, output_batch_dimension::Attribute, output_feature_dimension::Attribute, output_spatial_dimensions::Attribute, feature_group_count::Attribute, batch_group_count::Attribute, precision_config::Attribute, location=Location())
    op_ty_results = IR.Type[result, ]
    operands = Value[lhs, rhs, ]
    owned_regions = Region[]
    successors = Block[]
...
function cross_replica_sum_v1(operand::Value; result::IR.Type, replica_groups::Attribute, location=Location())
    op_ty_results = IR.Type[result, ]
    operands = Value[operand, ]
    owned_regions = Region[]
    successors = Block[]
...
function custom_call_v1(inputs::Vector{Value}; results::Tuple{Vararg{IR.Type}}, call_target_name::Attribute, has_side_effect::Attribute, backend_config::Attribute, api_version::Attribute, called_computations::Attribute, operand_layouts::Attribute, result_layouts::Attribute, output_operand_aliases::Attribute, location=Location())
    op_ty_results = IR.Type[results..., ]
    operands = Value[inputs..., ]
    owned_regions = Region[]
    successors = Block[]
...
function dot_general_v1(lhs::Value, rhs::Value; result::IR.Type, lhs_batching_dimensions::Attribute, rhs_batching_dimensions::Attribute, lhs_contracting_dimensions::Attribute, rhs_contracting_dimensions::Attribute, precision_config::Attribute, location=Location())
    op_ty_results = IR.Type[result, ]
    operands = Value[lhs, rhs, ]
    owned_regions = Region[]
    successors = Block[]
...
function dot_general_v2(lhs::Value, rhs::Value; result::IR.Type, lhs_batching_dimensions::Attribute, rhs_batching_dimensions::Attribute, lhs_contracting_dimensions::Attribute, rhs_contracting_dimensions::Attribute, precision_config::Attribute, lhs_precision_type::Attribute, rhs_precision_type::Attribute, accumulation_type::Attribute, lhs_component_count::Attribute, rhs_component_count::Attribute, num_primitive_operations::Attribute, allow_imprecise_accumulation::Attribute, location=Location())
    op_ty_results = IR.Type[result, ]
    operands = Value[lhs, rhs, ]
    owned_regions = Region[]
    successors = Block[]
...
function dot_v1(lhs::Value, rhs::Value; result::IR.Type, precision_config::Attribute, location=Location())
    op_ty_results = IR.Type[result, ]
    operands = Value[lhs, rhs, ]
    owned_regions = Region[]
    successors = Block[]
...
function dynamic_broadcast_in_dim_v1(operand::Value, output_dimensions::Value; result::IR.Type, broadcast_dimensions::Attribute, known_expanding_dimensions::Attribute, known_nonexpanding_dimensions::Attribute, location=Location())
    op_ty_results = IR.Type[result, ]
...
function dynamic_conv_v1(lhs::Value, rhs::Value, d_padding::Value; result::IR.Type, window_strides::Attribute, padding::Attribute, lhs_dilation::Attribute, rhs_dilation::Attribute, window_reversal::Attribute, input_batch_dimension::Attribute, input_feature_dimension::Attribute, input_spatial_dimensions::Attribute, kernel_input_feature_dimension::Attribute, kernel_output_feature_dimension::Attribute, kernel_spatial_dimensions::Attribute, output_batch_dimension::Attribute, output_feature_dimension::Attribute, output_spatial_dimensions::Attribute, feature_group_count::Attribute, batch_group_count::Attribute, precision_config::Attribute, location=Location())
    op_ty_results = IR.Type[result, ]
...
function dynamic_conv_v2(lhs::Value, rhs::Value, padding::Value; result::IR.Type, window_strides::Attribute, lhs_dilation::Attribute, rhs_dilation::Attribute, window_reversal::Attribute, input_batch_dimension::Attribute, input_feature_dimension::Attribute, input_spatial_dimensions::Attribute, kernel_input_feature_dimension::Attribute, kernel_output_feature_dimension::Attribute, kernel_spatial_dimensions::Attribute, output_batch_dimension::Attribute, output_feature_dimension::Attribute, output_spatial_dimensions::Attribute, feature_group_count::Attribute, batch_group_count::Attribute, precision_config::Attribute, location=Location())
    op_ty_results = IR.Type[result, ]
...
function dynamic_gather_v1(operand::Value, start_indices::Value, slice_sizes::Value; result::IR.Type, offset_dims::Attribute, collapsed_slice_dims::Attribute, start_index_map::Attribute, index_vector_dim::Attribute, indices_are_sorted::Attribute, location=Location())
    op_ty_results = IR.Type[result, ]
...
function dynamic_gather_v2(operand::Value, start_indices::Value, slice_sizes::Value; result::IR.Type, offset_dims::Attribute, collapsed_slice_dims::Attribute, operand_batching_dims::Attribute, start_indices_batching_dims::Attribute, start_index_map::Attribute, index_vector_dim::Attribute, indices_are_sorted::Attribute, location=Location())
    op_ty_results = IR.Type[result, ]
    operands = Value[operand, start_indices, slice_sizes, ]
    owned_regions = Region[]
    successors = Block[]
...
function dynamic_iota_v1(output_shape::Value; result::IR.Type, iota_dimension::Attribute, location=Location())
    op_ty_results = IR.Type[result, ]
...
function dynamic_slice_v1(operand::Value, start_indices::Vector{Value}; result::IR.Type, slice_sizes::Attribute, location=Location())
    op_ty_results = IR.Type[result, ]
...
function einsum_v1(lhs::Value, rhs::Value; result::IR.Type, einsum_config::Attribute, location=Location())
    op_ty_results = IR.Type[result, ]
    operands = Value[lhs, rhs, ]
    owned_regions = Region[]
    successors = Block[]
...
function fft_v1(operand::Value; result::IR.Type, fft_type::Attribute, fft_length::Attribute, location=Location())
    op_ty_results = IR.Type[result, ]
    operands = Value[operand, ]
    owned_regions = Region[]
    successors = Block[]
...
function func_v1(; sym_name::Attribute, function_type::Attribute, sym_visibility::Attribute, arg_attrs::Attribute, res_attrs::Attribute, body::Region, location=Location())
...
function gather_v1(operand::Value, start_indices::Value; result::IR.Type, offset_dims::Attribute, collapsed_slice_dims::Attribute, start_index_map::Attribute, index_vector_dim::Attribute, slice_sizes::Attribute, indices_are_sorted::Attribute, location=Location())
    op_ty_results = IR.Type[result, ]
    operands = Value[operand, start_indices, ]
    owned_regions = Region[]
    successors = Block[]
...
function gather_v2(operand::Value, start_indices::Value; result::IR.Type, offset_dims::Attribute, collapsed_slice_dims::Attribute, operand_batching_dims::Attribute, start_indices_batching_dims::Attribute, start_index_map::Attribute, index_vector_dim::Attribute, slice_sizes::Attribute, indices_are_sorted::Attribute, location=Location())
    op_ty_results = IR.Type[result, ]
    operands = Value[operand, start_indices, ]
    owned_regions = Region[]
    successors = Block[]
...
function get_dimension_size_v1(operand::Value; result::IR.Type, dimension::Attribute, location=Location())
    op_ty_results = IR.Type[result, ]
    operands = Value[operand, ]
    owned_regions = Region[]
    successors = Block[]
...
function get_tuple_element_v1(operand::Value; result::IR.Type, index::Attribute, location=Location())
    op_ty_results = IR.Type[result, ]
    operands = Value[operand, ]
    owned_regions = Region[]
    successors = Block[]
...
function if_v1(pred::Value; results::Tuple{Vararg{IR.Type}}, true_branch::Region, false_branch::Region, location=Location())
    op_ty_results = IR.Type[results..., ]
    operands = Value[pred, ]
...
function infeed_v1(token::Value; results::Tuple{Vararg{IR.Type}}, infeed_config::Attribute, layout::Attribute, location=Location())
    op_ty_results = IR.Type[results..., ]
...
function map_v1(inputs::Vector{Value}; result::IR.Type, dimensions::Attribute, computation::Region, location=Location())
    op_ty_results = IR.Type[result, ]
    operands = Value[inputs..., ]
    owned_regions = Region[computation, ]
    successors = Block[]
...
function optimization_barrier_v1(operand::Vector{Value}; result::Tuple{Vararg{IR.Type}}, location=Location())
    op_ty_results = IR.Type[result..., ]
    operands = Value[operand..., ]
    owned_regions = Region[]
    successors = Block[]
...
function outfeed_v1(inputs::Vector{Value}, token::Value; result::IR.Type, outfeed_config::Attribute, location=Location())
    op_ty_results = IR.Type[result, ]
...
function pad_v1(operand::Value, padding_value::Value; result::IR.Type, edge_padding_low::Attribute, edge_padding_high::Attribute, interior_padding::Attribute, location=Location())
    op_ty_results = IR.Type[result, ]
...
function recv_v1(token::Value; results::Tuple{Vararg{IR.Type}}, channel_id::Attribute, channel_type::Attribute, is_host_transfer::Attribute, location=Location())
    op_ty_results = IR.Type[results..., ]
    operands = Value[token, ]
    owned_regions = Region[]
    successors = Block[]
...
function reduce_v1(inputs::Vector{Value}, init_values::Vector{Value}; results::Tuple{Vararg{IR.Type}}, dimensions::Attribute, body::Region, location=Location())
    op_ty_results = IR.Type[results..., ]
...
function reduce_precision_v1(operand::Value; output::IR.Type, exponent_bits::Attribute, mantissa_bits::Attribute, location=Location())
    op_ty_results = IR.Type[output, ]
    operands = Value[operand, ]
    owned_regions = Region[]
    successors = Block[]
...
function reduce_scatter_v1(operand::Value; result::IR.Type, scatter_dimension::Attribute, replica_groups::Attribute, channel_id::Attribute, use_global_device_ids::Attribute, computation::Region, location=Location())
    op_ty_results = IR.Type[result, ]
    operands = Value[operand, ]
    owned_regions = Region[computation, ]
    successors = Block[]
...
function reduce_window_v1(inputs::Vector{Value}, init_values::Vector{Value}; results::Tuple{Vararg{IR.Type}}, window_dimensions::Attribute, window_strides::Attribute, base_dilations::Attribute, window_dilations::Attribute, padding::Attribute, body::Region, location=Location())
    op_ty_results = IR.Type[results..., ]
    operands = Value[inputs..., init_values..., ]
    owned_regions = Region[body, ]
    successors = Block[]
...
function reverse_v1(operand::Value; result::IR.Type, dimensions::Attribute, location=Location())
    op_ty_results = IR.Type[result, ]
    operands = Value[operand, ]
    owned_regions = Region[]
    successors = Block[]
...
function rng_bit_generator_v1(initial_state::Value; output_state::IR.Type, output::IR.Type, rng_algorithm::Attribute, location=Location())
...
function rng_v1(a::Value, b::Value, shape::Value; result::IR.Type, rng_distribution::Attribute, location=Location())
    op_ty_results = IR.Type[result, ]
...
function scatter_v1(inputs::Vector{Value}, scatter_indices::Value, updates::Vector{Value}; results::Tuple{Vararg{IR.Type}}, update_window_dims::Attribute, inserted_window_dims::Attribute, scatter_dims_to_operand_dims::Attribute, index_vector_dim::Attribute, indices_are_sorted::Attribute, unique_indices::Attribute, update_computation::Region, location=Location())
    op_ty_results = IR.Type[results..., ]
...
function scatter_v2(inputs::Vector{Value}, scatter_indices::Value, updates::Vector{Value}; results::Tuple{Vararg{IR.Type}}, update_window_dims::Attribute, inserted_window_dims::Attribute, input_batching_dims::Attribute, scatter_indices_batching_dims::Attribute, scatter_dims_to_operand_dims::Attribute, index_vector_dim::Attribute, indices_are_sorted::Attribute, unique_indices::Attribute, update_computation::Region, location=Location())
    op_ty_results = IR.Type[results..., ]
    operands = Value[inputs..., scatter_indices, updates..., ]
    owned_regions = Region[update_computation, ]
    successors = Block[]
...
function select_and_scatter_v1(operand::Value, source::Value, init_value::Value; result::IR.Type, window_dimensions::Attribute, window_strides::Attribute, padding::Attribute, select::Region, scatter::Region, location=Location())
    op_ty_results = IR.Type[result, ]
...
function send_v1(inputs::Vector{Value}, token::Value; result::IR.Type, channel_id::Attribute, channel_type::Attribute, is_host_transfer::Attribute, location=Location())
    op_ty_results = IR.Type[result, ]
    operands = Value[inputs..., token, ]
    owned_regions = Region[]
    successors = Block[]
...
function set_dimension_size_v1(operand::Value, size::Value; result::IR.Type, dimension::Attribute, location=Location())
    op_ty_results = IR.Type[result, ]
...
function slice_v1(operand::Value; result::IR.Type, start_indices::Attribute, limit_indices::Attribute, strides::Attribute, location=Location())
    op_ty_results = IR.Type[result, ]
    operands = Value[operand, ]
    owned_regions = Region[]
    successors = Block[]
...
function sort_v1(inputs::Vector{Value}; results::Tuple{Vararg{IR.Type}}, dimension::Attribute, is_stable::Attribute, comparator::Region, location=Location())
    op_ty_results = IR.Type[results..., ]
    operands = Value[inputs..., ]
...
function torch_index_select_v1(operand::Value, index::Value; result::IR.Type, dim::Attribute, batch_dims::Attribute, location=Location())
    op_ty_results = IR.Type[result, ]
...
function transpose_v1(operand::Value; result::IR.Type, permutation::Attribute, location=Location())
    op_ty_results = IR.Type[result, ]
    operands = Value[operand, ]
    owned_regions = Region[]
    successors = Block[]
...
function triangular_solve_v1(a::Value, b::Value; result::IR.Type, left_side::Attribute, lower::Attribute, unit_diagonal::Attribute, transpose_a::Attribute, location=Location())
    op_ty_results = IR.Type[result, ]
    operands = Value[a, b, ]
    owned_regions = Region[]
    successors = Block[]
...
function unary_einsum_v1(operand::Value; result::IR.Type, einsum_config::Attribute, location=Location())
    op_ty_results = IR.Type[result, ]
    operands = Value[operand, ]
    owned_regions = Region[]
    successors = Block[]
...
function while_v1(operand::Vector{Value}; results::Tuple{Vararg{IR.Type}}, cond::Region, body::Region, location=Location())
    op_ty_results = IR.Type[results..., ]
    operands = Value[operand..., ]
