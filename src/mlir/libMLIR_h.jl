...
function mlirOpPrintingFlagsElideLargeResourceString(flags, largeResourceLimit)
    @ccall mlir_c.mlirOpPrintingFlagsElideLargeResourceString(flags::MlirOpPrintingFlags, largeResourceLimit::intptr_t)::Cvoid
end
...
function mlirValueReplaceAllUsesExcept(of, with, numExceptions, exceptions)
    @ccall mlir_c.mlirValueReplaceAllUsesExcept(of::MlirValue, with::MlirValue, numExceptions::intptr_t, exceptions::Ptr{MlirOperation})::Cvoid
end
...
function mlirLLVMDICompositeTypeAttrGet(ctx, recId, isRecSelf, tag, name, file, line, scope, baseType, flags, sizeInBits, alignInBits, nElements, elements, dataLocation, rank, allocated, associated)
    @ccall mlir_c.mlirLLVMDICompositeTypeAttrGet(ctx::MlirContext, recId::MlirAttribute, isRecSelf::Bool, tag::Cuint, name::MlirAttribute, file::MlirAttribute, line::UInt32, scope::MlirAttribute, baseType::MlirAttribute, flags::Int64, sizeInBits::UInt64, alignInBits::UInt64, nElements::intptr_t, elements::Ptr{MlirAttribute}, dataLocation::MlirAttribute, rank::MlirAttribute, allocated::MlirAttribute, associated::MlirAttribute)::MlirAttribute
end
...
"""
function mlirLLVMDICompileUnitAttrGet(ctx, id, sourceLanguage, file, producer, isOptimized, emissionKind, nameTableKind)
    @ccall mlir_c.mlirLLVMDICompileUnitAttrGet(ctx::MlirContext, id::MlirAttribute, sourceLanguage::Cuint, file::MlirAttribute, producer::MlirAttribute, isOptimized::Bool, emissionKind::MlirLLVMDIEmissionKind, nameTableKind::MlirLLVMDINameTableKind)::MlirAttribute
end
...
function mlirLLVMDIImportedEntityAttrGet(ctx, tag, scope, entity, file, line, name, nElements, elements)
    @ccall mlir_c.mlirLLVMDIImportedEntityAttrGet(ctx::MlirContext, tag::Cuint, scope::MlirAttribute, entity::MlirAttribute, file::MlirAttribute, line::Cuint, name::MlirAttribute, nElements::intptr_t, elements::Ptr{MlirAttribute})::MlirAttribute
end
...
function mlirSparseTensorEncodingAttrGet(ctx, lvlRank, lvlTypes, dimToLvl, lvlTodim, posWidth, crdWidth, explicitVal, implicitVal)
    @ccall mlir_c.mlirSparseTensorEncodingAttrGet(ctx::MlirContext, lvlRank::intptr_t, lvlTypes::Ptr{MlirSparseTensorLevelType}, dimToLvl::MlirAffineMap, lvlTodim::MlirAffineMap, posWidth::Cint, crdWidth::Cint, explicitVal::MlirAttribute, implicitVal::MlirAttribute)::MlirAttribute
end
...
function mlirRewriterBaseCreateBlockBefore(rewriter, insertBefore, nArgTypes, argTypes, locations)
    @ccall mlir_c.mlirRewriterBaseCreateBlockBefore(rewriter::MlirRewriterBase, insertBefore::MlirBlock, nArgTypes::intptr_t, argTypes::Ptr{MlirType}, locations::Ptr{MlirLocation})::MlirBlock
end
...
function mlirRewriterBaseReplaceOpWithValues(rewriter, op, nValues, values)
    @ccall mlir_c.mlirRewriterBaseReplaceOpWithValues(rewriter::MlirRewriterBase, op::MlirOperation, nValues::intptr_t, values::Ptr{MlirValue})::Cvoid
end
...
function mlirRewriterBaseInlineBlockBefore(rewriter, source, op, nArgValues, argValues)
    @ccall mlir_c.mlirRewriterBaseInlineBlockBefore(rewriter::MlirRewriterBase, source::MlirBlock, op::MlirOperation, nArgValues::intptr_t, argValues::Ptr{MlirValue})::Cvoid
end
...
function mlirRewriterBaseMergeBlocks(rewriter, source, dest, nArgValues, argValues)
    @ccall mlir_c.mlirRewriterBaseMergeBlocks(rewriter::MlirRewriterBase, source::MlirBlock, dest::MlirBlock, nArgValues::intptr_t, argValues::Ptr{MlirValue})::Cvoid
end
...
function mlirRewriterBaseReplaceAllValueRangeUsesWith(rewriter, nValues, from, to)
    @ccall mlir_c.mlirRewriterBaseReplaceAllValueRangeUsesWith(rewriter::MlirRewriterBase, nValues::intptr_t, from::Ptr{MlirValue}, to::Ptr{MlirValue})::Cvoid
end
...
function mlirRewriterBaseReplaceAllOpUsesWithValueRange(rewriter, from, nTo, to)
    @ccall mlir_c.mlirRewriterBaseReplaceAllOpUsesWithValueRange(rewriter::MlirRewriterBase, from::MlirOperation, nTo::intptr_t, to::Ptr{MlirValue})::Cvoid
end
...
function mlirRewriterBaseReplaceOpUsesWithinBlock(rewriter, op, nNewValues, newValues, block)
    @ccall mlir_c.mlirRewriterBaseReplaceOpUsesWithinBlock(rewriter::MlirRewriterBase, op::MlirOperation, nNewValues::intptr_t, newValues::Ptr{MlirValue}, block::MlirBlock)::Cvoid
end
...
function mlirFreezeRewritePattern(op)
    @ccall mlir_c.mlirFreezeRewritePattern(op::MlirRewritePatternSet)::MlirFrozenRewritePatternSet
end
...
function stablehloScatterDimensionNumbersGetInputBatchingDimsSize(attr)
    @ccall mlir_c.stablehloScatterDimensionNumbersGetInputBatchingDimsSize(attr::MlirAttribute)::intptr_t
end

function stablehloScatterDimensionNumbersGetInputBatchingDimsElem(attr, pos)
    @ccall mlir_c.stablehloScatterDimensionNumbersGetInputBatchingDimsElem(attr::MlirAttribute, pos::intptr_t)::Int64
end

function stablehloScatterDimensionNumbersGetScatterIndicesBatchingDimsSize(attr)
    @ccall mlir_c.stablehloScatterDimensionNumbersGetScatterIndicesBatchingDimsSize(attr::MlirAttribute)::intptr_t
end

function stablehloScatterDimensionNumbersGetScatterIndicesBatchingDimsElem(attr, pos)
    @ccall mlir_c.stablehloScatterDimensionNumbersGetScatterIndicesBatchingDimsElem(attr::MlirAttribute, pos::intptr_t)::Int64
end
...
function stablehloGatherDimensionNumbersGet(ctx, nOffsetDims, offsetDims, nCollapsedSliceDims, collapsedSliceDims, nOperandBatchingDims, operandBatchingDims, nStartIndicesBatchingDims, startIndicesBatchingDims, nStartIndexMap, startIndexMap, indexVectorDim)
    @ccall mlir_c.stablehloGatherDimensionNumbersGet(ctx::MlirContext, nOffsetDims::intptr_t, offsetDims::Ptr{Int64}, nCollapsedSliceDims::intptr_t, collapsedSliceDims::Ptr{Int64}, nOperandBatchingDims::intptr_t, operandBatchingDims::Ptr{Int64}, nStartIndicesBatchingDims::intptr_t, startIndicesBatchingDims::Ptr{Int64}, nStartIndexMap::intptr_t, startIndexMap::Ptr{Int64}, indexVectorDim::Int64)::MlirAttribute
end
...
function stablehloGatherDimensionNumbersGetOperandBatchingDimsSize(attr)
    @ccall mlir_c.stablehloGatherDimensionNumbersGetOperandBatchingDimsSize(attr::MlirAttribute)::intptr_t
end

function stablehloGatherDimensionNumbersGetOperandBatchingDimsElem(attr, pos)
    @ccall mlir_c.stablehloGatherDimensionNumbersGetOperandBatchingDimsElem(attr::MlirAttribute, pos::intptr_t)::Int64
end

function stablehloGatherDimensionNumbersGetStartIndicesBatchingDimsSize(attr)
    @ccall mlir_c.stablehloGatherDimensionNumbersGetStartIndicesBatchingDimsSize(attr::MlirAttribute)::intptr_t
end

function stablehloGatherDimensionNumbersGetStartIndicesBatchingDimsElem(attr, pos)
    @ccall mlir_c.stablehloGatherDimensionNumbersGetStartIndicesBatchingDimsElem(attr::MlirAttribute, pos::intptr_t)::Int64
end
