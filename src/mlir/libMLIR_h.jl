...
"""
function mlirLocationFileLineColRangeGet(context, filename, start_line, start_col, end_line, end_col)
    @ccall mlir_c.mlirLocationFileLineColRangeGet(context::MlirContext, filename::MlirStringRef, start_line::Cuint, start_col::Cuint, end_line::Cuint, end_col::Cuint)::MlirLocation
end
...
function mlirLocationFileLineColRangeGetFilename(location)
    @ccall mlir_c.mlirLocationFileLineColRangeGetFilename(location::MlirLocation)::MlirIdentifier
end
...
function mlirLocationFusedGet(ctx, nLocations, locations, metadata)
    @ccall mlir_c.mlirLocationFusedGet(ctx::MlirContext, nLocations::Cptrdiff_t, locations::Ptr{MlirLocation}, metadata::MlirAttribute)::MlirLocation
end
...
function mlirLocationFusedGetLocations(location, locationsCPtr)
    @ccall mlir_c.mlirLocationFusedGetLocations(location::MlirLocation, locationsCPtr::Ptr{MlirLocation})::Cvoid
end
...
function mlirModuleCreateParseFromFile(context, fileName)
    @ccall mlir_c.mlirModuleCreateParseFromFile(context::MlirContext, fileName::MlirStringRef)::MlirModule
end
...
function mlirOperationStateAddOperands(state, n, operands)
    @ccall mlir_c.mlirOperationStateAddOperands(state::Ptr{MlirOperationState}, n::Cptrdiff_t, operands::Ptr{MlirValue})::Cvoid
end

function mlirOperationStateAddOwnedRegions(state, n, regions)
    @ccall mlir_c.mlirOperationStateAddOwnedRegions(state::Ptr{MlirOperationState}, n::Cptrdiff_t, regions::Ptr{MlirRegion})::Cvoid
end

function mlirOperationStateAddSuccessors(state, n, successors)
    @ccall mlir_c.mlirOperationStateAddSuccessors(state::Ptr{MlirOperationState}, n::Cptrdiff_t, successors::Ptr{MlirBlock})::Cvoid
end

function mlirOperationStateAddAttributes(state, n, attributes)
    @ccall mlir_c.mlirOperationStateAddAttributes(state::Ptr{MlirOperationState}, n::Cptrdiff_t, attributes::Ptr{MlirNamedAttribute})::Cvoid
end
...
function mlirOpPrintingFlagsElideLargeElementsAttrs(flags, largeElementLimit)
    @ccall mlir_c.mlirOpPrintingFlagsElideLargeElementsAttrs(flags::MlirOpPrintingFlags, largeElementLimit::Cptrdiff_t)::Cvoid
end
...
function mlirOpPrintingFlagsElideLargeResourceString(flags, largeResourceLimit)
    @ccall mlir_c.mlirOpPrintingFlagsElideLargeResourceString(flags::MlirOpPrintingFlags, largeResourceLimit::Cptrdiff_t)::Cvoid
end
...
function mlirOperationSetOperand(op, pos, newValue)
    @ccall mlir_c.mlirOperationSetOperand(op::MlirOperation, pos::Cptrdiff_t, newValue::MlirValue)::Cvoid
end
...
function mlirOperationSetOperands(op, nOperands, operands)
    @ccall mlir_c.mlirOperationSetOperands(op::MlirOperation, nOperands::Cptrdiff_t, operands::Ptr{MlirValue})::Cvoid
end
...
function mlirOperationSetSuccessor(op, pos, block)
    @ccall mlir_c.mlirOperationSetSuccessor(op::MlirOperation, pos::Cptrdiff_t, block::MlirBlock)::Cvoid
end
...
function mlirOperationGetDiscardableAttribute(op, pos)
    @ccall mlir_c.mlirOperationGetDiscardableAttribute(op::MlirOperation, pos::Cptrdiff_t)::MlirNamedAttribute
end
...
function mlirOperationGetAttribute(op, pos)
    @ccall mlir_c.mlirOperationGetAttribute(op::MlirOperation, pos::Cptrdiff_t)::MlirNamedAttribute
end
...
function mlirOperationIsBeforeInBlock(op, other)
    @ccall mlir_c.mlirOperationIsBeforeInBlock(op::MlirOperation, other::MlirOperation)::Bool
end
...
function mlirRegionInsertOwnedBlock(region, pos, block)
    @ccall mlir_c.mlirRegionInsertOwnedBlock(region::MlirRegion, pos::Cptrdiff_t, block::MlirBlock)::Cvoid
end
...
function mlirBlockCreate(nArgs, args, locs)
    @ccall mlir_c.mlirBlockCreate(nArgs::Cptrdiff_t, args::Ptr{MlirType}, locs::Ptr{MlirLocation})::MlirBlock
end
...
function mlirBlockInsertOwnedOperation(block, pos, operation)
    @ccall mlir_c.mlirBlockInsertOwnedOperation(block::MlirBlock, pos::Cptrdiff_t, operation::MlirOperation)::Cvoid
end
...
function mlirBlockInsertArgument(block, pos, type, loc)
    @ccall mlir_c.mlirBlockInsertArgument(block::MlirBlock, pos::Cptrdiff_t, type::MlirType, loc::MlirLocation)::MlirValue
end
...
function mlirValueReplaceAllUsesExcept(of, with, numExceptions, exceptions)
    @ccall mlir_c.mlirValueReplaceAllUsesExcept(of::MlirValue, with::MlirValue, numExceptions::Cptrdiff_t, exceptions::Ptr{MlirOperation})::Cvoid
end
...
function mlirAffineExprIsFunctionOfDim(affineExpr, position)
    @ccall mlir_c.mlirAffineExprIsFunctionOfDim(affineExpr::MlirAffineExpr, position::Cptrdiff_t)::Bool
end
...
function mlirAffineExprShiftDims(affineExpr, numDims, shift, offset)
    @ccall mlir_c.mlirAffineExprShiftDims(affineExpr::MlirAffineExpr, numDims::UInt32, shift::UInt32, offset::UInt32)::MlirAffineExpr
end
...
function mlirAffineExprShiftSymbols(affineExpr, numSymbols, shift, offset)
    @ccall mlir_c.mlirAffineExprShiftSymbols(affineExpr::MlirAffineExpr, numSymbols::UInt32, shift::UInt32, offset::UInt32)::MlirAffineExpr
end
...
function mlirSimplifyAffineExpr(expr, numDims, numSymbols)
    @ccall mlir_c.mlirSimplifyAffineExpr(expr::MlirAffineExpr, numDims::UInt32, numSymbols::UInt32)::MlirAffineExpr
end
...
function mlirAffineDimExprGet(ctx, position)
    @ccall mlir_c.mlirAffineDimExprGet(ctx::MlirContext, position::Cptrdiff_t)::MlirAffineExpr
end
...
function mlirAffineSymbolExprGet(ctx, position)
    @ccall mlir_c.mlirAffineSymbolExprGet(ctx::MlirContext, position::Cptrdiff_t)::MlirAffineExpr
end
...
function mlirAffineMapZeroResultGet(ctx, dimCount, symbolCount)
    @ccall mlir_c.mlirAffineMapZeroResultGet(ctx::MlirContext, dimCount::Cptrdiff_t, symbolCount::Cptrdiff_t)::MlirAffineMap
end
...
function mlirAffineMapGet(ctx, dimCount, symbolCount, nAffineExprs, affineExprs)
    @ccall mlir_c.mlirAffineMapGet(ctx::MlirContext, dimCount::Cptrdiff_t, symbolCount::Cptrdiff_t, nAffineExprs::Cptrdiff_t, affineExprs::Ptr{MlirAffineExpr})::MlirAffineMap
end
...
function mlirAffineMapMinorIdentityGet(ctx, dims, results)
    @ccall mlir_c.mlirAffineMapMinorIdentityGet(ctx::MlirContext, dims::Cptrdiff_t, results::Cptrdiff_t)::MlirAffineMap
end
...
function mlirAffineMapPermutationGet(ctx, size, permutation)
    @ccall mlir_c.mlirAffineMapPermutationGet(ctx::MlirContext, size::Cptrdiff_t, permutation::Ptr{Cuint})::MlirAffineMap
end
...
function mlirAffineMapGetResult(affineMap, pos)
    @ccall mlir_c.mlirAffineMapGetResult(affineMap::MlirAffineMap, pos::Cptrdiff_t)::MlirAffineExpr
end
...
function mlirAffineMapGetSubMap(affineMap, size, resultPos)
    @ccall mlir_c.mlirAffineMapGetSubMap(affineMap::MlirAffineMap, size::Cptrdiff_t, resultPos::Ptr{Cptrdiff_t})::MlirAffineMap
end
...
function mlirAffineMapGetMajorSubMap(affineMap, numResults)
    @ccall mlir_c.mlirAffineMapGetMajorSubMap(affineMap::MlirAffineMap, numResults::Cptrdiff_t)::MlirAffineMap
end
...
function mlirAffineMapReplace(affineMap, expression, replacement, numResultDims, numResultSyms)
    @ccall mlir_c.mlirAffineMapReplace(affineMap::MlirAffineMap, expression::MlirAffineExpr, replacement::MlirAffineExpr, numResultDims::Cptrdiff_t, numResultSyms::Cptrdiff_t)::MlirAffineMap
end
...
function mlirAffineMapCompressUnusedSymbols(affineMaps, size, result, populateResult)
    @ccall mlir_c.mlirAffineMapCompressUnusedSymbols(affineMaps::Ptr{MlirAffineMap}, size::Cptrdiff_t, result::Ptr{Cvoid}, populateResult::Ptr{Cvoid})::Cvoid
end
...
function mlirIntegerSetEmptyGet(context, numDims, numSymbols)
    @ccall mlir_c.mlirIntegerSetEmptyGet(context::MlirContext, numDims::Cptrdiff_t, numSymbols::Cptrdiff_t)::MlirIntegerSet
end
...
function mlirIntegerSetGet(context, numDims, numSymbols, numConstraints, constraints, eqFlags)
    @ccall mlir_c.mlirIntegerSetGet(context::MlirContext, numDims::Cptrdiff_t, numSymbols::Cptrdiff_t, numConstraints::Cptrdiff_t, constraints::Ptr{MlirAffineExpr}, eqFlags::Ptr{Bool})::MlirIntegerSet
end
...
function mlirIntegerSetReplaceGet(set, dimReplacements, symbolReplacements, numResultDims, numResultSymbols)
    @ccall mlir_c.mlirIntegerSetReplaceGet(set::MlirIntegerSet, dimReplacements::Ptr{MlirAffineExpr}, symbolReplacements::Ptr{MlirAffineExpr}, numResultDims::Cptrdiff_t, numResultSymbols::Cptrdiff_t)::MlirIntegerSet
end
...
function mlirIntegerSetGetConstraint(set, pos)
    @ccall mlir_c.mlirIntegerSetGetConstraint(set::MlirIntegerSet, pos::Cptrdiff_t)::MlirAffineExpr
end
...
function mlirArrayAttrGet(ctx, numElements, elements)
    @ccall mlir_c.mlirArrayAttrGet(ctx::MlirContext, numElements::Cptrdiff_t, elements::Ptr{MlirAttribute})::MlirAttribute
end
...
function mlirArrayAttrGetElement(attr, pos)
    @ccall mlir_c.mlirArrayAttrGetElement(attr::MlirAttribute, pos::Cptrdiff_t)::MlirAttribute
end
...
function mlirDictionaryAttrGet(ctx, numElements, elements)
    @ccall mlir_c.mlirDictionaryAttrGet(ctx::MlirContext, numElements::Cptrdiff_t, elements::Ptr{MlirNamedAttribute})::MlirAttribute
end
...
function mlirDictionaryAttrGetElement(attr, pos)
    @ccall mlir_c.mlirDictionaryAttrGetElement(attr::MlirAttribute, pos::Cptrdiff_t)::MlirNamedAttribute
end
...
function mlirOpaqueAttrGet(ctx, dialectNamespace, dataLength, data, type)
    @ccall mlir_c.mlirOpaqueAttrGet(ctx::MlirContext, dialectNamespace::MlirStringRef, dataLength::Cptrdiff_t, data::Cstring, type::MlirType)::MlirAttribute
end
...
function mlirSymbolRefAttrGet(ctx, symbol, numReferences, references)
    @ccall mlir_c.mlirSymbolRefAttrGet(ctx::MlirContext, symbol::MlirStringRef, numReferences::Cptrdiff_t, references::Ptr{MlirAttribute})::MlirAttribute
end
...
function mlirSymbolRefAttrGetNestedReference(attr, pos)
    @ccall mlir_c.mlirSymbolRefAttrGetNestedReference(attr::MlirAttribute, pos::Cptrdiff_t)::MlirAttribute
end
...
function mlirElementsAttrGetValue(attr, rank, idxs)
    @ccall mlir_c.mlirElementsAttrGetValue(attr::MlirAttribute, rank::Cptrdiff_t, idxs::Ptr{UInt64})::MlirAttribute
end
...
function mlirElementsAttrIsValidIndex(attr, rank, idxs)
    @ccall mlir_c.mlirElementsAttrIsValidIndex(attr::MlirAttribute, rank::Cptrdiff_t, idxs::Ptr{UInt64})::Bool
end
...
function mlirDenseBoolArrayGet(ctx, size, values)
    @ccall mlir_c.mlirDenseBoolArrayGet(ctx::MlirContext, size::Cptrdiff_t, values::Ptr{Cint})::MlirAttribute
end

function mlirDenseI8ArrayGet(ctx, size, values)
    @ccall mlir_c.mlirDenseI8ArrayGet(ctx::MlirContext, size::Cptrdiff_t, values::Ptr{Int8})::MlirAttribute
end

function mlirDenseI16ArrayGet(ctx, size, values)
    @ccall mlir_c.mlirDenseI16ArrayGet(ctx::MlirContext, size::Cptrdiff_t, values::Ptr{Int16})::MlirAttribute
end

function mlirDenseI32ArrayGet(ctx, size, values)
    @ccall mlir_c.mlirDenseI32ArrayGet(ctx::MlirContext, size::Cptrdiff_t, values::Ptr{Int32})::MlirAttribute
end

function mlirDenseI64ArrayGet(ctx, size, values)
    @ccall mlir_c.mlirDenseI64ArrayGet(ctx::MlirContext, size::Cptrdiff_t, values::Ptr{Int64})::MlirAttribute
end

function mlirDenseF32ArrayGet(ctx, size, values)
    @ccall mlir_c.mlirDenseF32ArrayGet(ctx::MlirContext, size::Cptrdiff_t, values::Ptr{Cfloat})::MlirAttribute
end

function mlirDenseF64ArrayGet(ctx, size, values)
    @ccall mlir_c.mlirDenseF64ArrayGet(ctx::MlirContext, size::Cptrdiff_t, values::Ptr{Cdouble})::MlirAttribute
end
...
function mlirDenseElementsAttrGet(shapedType, numElements, elements)
    @ccall mlir_c.mlirDenseElementsAttrGet(shapedType::MlirType, numElements::Cptrdiff_t, elements::Ptr{MlirAttribute})::MlirAttribute
end
...
function mlirDenseElementsAttrBoolGet(shapedType, numElements, elements)
    @ccall mlir_c.mlirDenseElementsAttrBoolGet(shapedType::MlirType, numElements::Cptrdiff_t, elements::Ptr{Cint})::MlirAttribute
end

function mlirDenseElementsAttrUInt8Get(shapedType, numElements, elements)
    @ccall mlir_c.mlirDenseElementsAttrUInt8Get(shapedType::MlirType, numElements::Cptrdiff_t, elements::Ptr{UInt8})::MlirAttribute
end

function mlirDenseElementsAttrInt8Get(shapedType, numElements, elements)
    @ccall mlir_c.mlirDenseElementsAttrInt8Get(shapedType::MlirType, numElements::Cptrdiff_t, elements::Ptr{Int8})::MlirAttribute
end
...
function mlirDenseElementsAttrInt16Get(shapedType, numElements, elements)
    @ccall mlir_c.mlirDenseElementsAttrInt16Get(shapedType::MlirType, numElements::Cptrdiff_t, elements::Ptr{Int16})::MlirAttribute
end

function mlirDenseElementsAttrUInt32Get(shapedType, numElements, elements)
    @ccall mlir_c.mlirDenseElementsAttrUInt32Get(shapedType::MlirType, numElements::Cptrdiff_t, elements::Ptr{UInt32})::MlirAttribute
end

function mlirDenseElementsAttrInt32Get(shapedType, numElements, elements)
    @ccall mlir_c.mlirDenseElementsAttrInt32Get(shapedType::MlirType, numElements::Cptrdiff_t, elements::Ptr{Int32})::MlirAttribute
end

function mlirDenseElementsAttrUInt64Get(shapedType, numElements, elements)
    @ccall mlir_c.mlirDenseElementsAttrUInt64Get(shapedType::MlirType, numElements::Cptrdiff_t, elements::Ptr{UInt64})::MlirAttribute
end

function mlirDenseElementsAttrInt64Get(shapedType, numElements, elements)
    @ccall mlir_c.mlirDenseElementsAttrInt64Get(shapedType::MlirType, numElements::Cptrdiff_t, elements::Ptr{Int64})::MlirAttribute
end
...
function mlirDenseElementsAttrDoubleGet(shapedType, numElements, elements)
    @ccall mlir_c.mlirDenseElementsAttrDoubleGet(shapedType::MlirType, numElements::Cptrdiff_t, elements::Ptr{Cdouble})::MlirAttribute
end
...
function mlirDenseElementsAttrStringGet(shapedType, numElements, strs)
    @ccall mlir_c.mlirDenseElementsAttrStringGet(shapedType::MlirType, numElements::Cptrdiff_t, strs::Ptr{MlirStringRef})::MlirAttribute
end
...
function mlirDenseElementsAttrGetBoolValue(attr, pos)
    @ccall mlir_c.mlirDenseElementsAttrGetBoolValue(attr::MlirAttribute, pos::Cptrdiff_t)::Bool
end

function mlirDenseElementsAttrGetInt8Value(attr, pos)
    @ccall mlir_c.mlirDenseElementsAttrGetInt8Value(attr::MlirAttribute, pos::Cptrdiff_t)::Int8
end

function mlirDenseElementsAttrGetUInt8Value(attr, pos)
    @ccall mlir_c.mlirDenseElementsAttrGetUInt8Value(attr::MlirAttribute, pos::Cptrdiff_t)::UInt8
end

function mlirDenseElementsAttrGetInt16Value(attr, pos)
    @ccall mlir_c.mlirDenseElementsAttrGetInt16Value(attr::MlirAttribute, pos::Cptrdiff_t)::Int16
end

function mlirDenseElementsAttrGetUInt16Value(attr, pos)
    @ccall mlir_c.mlirDenseElementsAttrGetUInt16Value(attr::MlirAttribute, pos::Cptrdiff_t)::UInt16
end

function mlirDenseElementsAttrGetInt32Value(attr, pos)
    @ccall mlir_c.mlirDenseElementsAttrGetInt32Value(attr::MlirAttribute, pos::Cptrdiff_t)::Int32
end

function mlirDenseElementsAttrGetUInt32Value(attr, pos)
    @ccall mlir_c.mlirDenseElementsAttrGetUInt32Value(attr::MlirAttribute, pos::Cptrdiff_t)::UInt32
end

function mlirDenseElementsAttrGetInt64Value(attr, pos)
    @ccall mlir_c.mlirDenseElementsAttrGetInt64Value(attr::MlirAttribute, pos::Cptrdiff_t)::Int64
end

function mlirDenseElementsAttrGetUInt64Value(attr, pos)
    @ccall mlir_c.mlirDenseElementsAttrGetUInt64Value(attr::MlirAttribute, pos::Cptrdiff_t)::UInt64
end

function mlirDenseElementsAttrGetIndexValue(attr, pos)
    @ccall mlir_c.mlirDenseElementsAttrGetIndexValue(attr::MlirAttribute, pos::Cptrdiff_t)::UInt64
end
...
function mlirDenseElementsAttrGetDoubleValue(attr, pos)
    @ccall mlir_c.mlirDenseElementsAttrGetDoubleValue(attr::MlirAttribute, pos::Cptrdiff_t)::Cdouble
end

function mlirDenseElementsAttrGetStringValue(attr, pos)
    @ccall mlir_c.mlirDenseElementsAttrGetStringValue(attr::MlirAttribute, pos::Cptrdiff_t)::MlirStringRef
end
...
function mlirUnmanagedDenseBoolResourceElementsAttrGet(shapedType, name, numElements, elements)
    @ccall mlir_c.mlirUnmanagedDenseBoolResourceElementsAttrGet(shapedType::MlirType, name::MlirStringRef, numElements::Cptrdiff_t, elements::Ptr{Cint})::MlirAttribute
end

function mlirUnmanagedDenseUInt8ResourceElementsAttrGet(shapedType, name, numElements, elements)
    @ccall mlir_c.mlirUnmanagedDenseUInt8ResourceElementsAttrGet(shapedType::MlirType, name::MlirStringRef, numElements::Cptrdiff_t, elements::Ptr{UInt8})::MlirAttribute
end

function mlirUnmanagedDenseInt8ResourceElementsAttrGet(shapedType, name, numElements, elements)
    @ccall mlir_c.mlirUnmanagedDenseInt8ResourceElementsAttrGet(shapedType::MlirType, name::MlirStringRef, numElements::Cptrdiff_t, elements::Ptr{Int8})::MlirAttribute
end

function mlirUnmanagedDenseUInt16ResourceElementsAttrGet(shapedType, name, numElements, elements)
    @ccall mlir_c.mlirUnmanagedDenseUInt16ResourceElementsAttrGet(shapedType::MlirType, name::MlirStringRef, numElements::Cptrdiff_t, elements::Ptr{UInt16})::MlirAttribute
end

function mlirUnmanagedDenseInt16ResourceElementsAttrGet(shapedType, name, numElements, elements)
    @ccall mlir_c.mlirUnmanagedDenseInt16ResourceElementsAttrGet(shapedType::MlirType, name::MlirStringRef, numElements::Cptrdiff_t, elements::Ptr{Int16})::MlirAttribute
end

function mlirUnmanagedDenseUInt32ResourceElementsAttrGet(shapedType, name, numElements, elements)
    @ccall mlir_c.mlirUnmanagedDenseUInt32ResourceElementsAttrGet(shapedType::MlirType, name::MlirStringRef, numElements::Cptrdiff_t, elements::Ptr{UInt32})::MlirAttribute
end

function mlirUnmanagedDenseInt32ResourceElementsAttrGet(shapedType, name, numElements, elements)
    @ccall mlir_c.mlirUnmanagedDenseInt32ResourceElementsAttrGet(shapedType::MlirType, name::MlirStringRef, numElements::Cptrdiff_t, elements::Ptr{Int32})::MlirAttribute
end

function mlirUnmanagedDenseUInt64ResourceElementsAttrGet(shapedType, name, numElements, elements)
    @ccall mlir_c.mlirUnmanagedDenseUInt64ResourceElementsAttrGet(shapedType::MlirType, name::MlirStringRef, numElements::Cptrdiff_t, elements::Ptr{UInt64})::MlirAttribute
end

function mlirUnmanagedDenseInt64ResourceElementsAttrGet(shapedType, name, numElements, elements)
    @ccall mlir_c.mlirUnmanagedDenseInt64ResourceElementsAttrGet(shapedType::MlirType, name::MlirStringRef, numElements::Cptrdiff_t, elements::Ptr{Int64})::MlirAttribute
end

function mlirUnmanagedDenseFloatResourceElementsAttrGet(shapedType, name, numElements, elements)
    @ccall mlir_c.mlirUnmanagedDenseFloatResourceElementsAttrGet(shapedType::MlirType, name::MlirStringRef, numElements::Cptrdiff_t, elements::Ptr{Cfloat})::MlirAttribute
end

function mlirUnmanagedDenseDoubleResourceElementsAttrGet(shapedType, name, numElements, elements)
    @ccall mlir_c.mlirUnmanagedDenseDoubleResourceElementsAttrGet(shapedType::MlirType, name::MlirStringRef, numElements::Cptrdiff_t, elements::Ptr{Cdouble})::MlirAttribute
end
...
function mlirDenseBoolResourceElementsAttrGetValue(attr, pos)
    @ccall mlir_c.mlirDenseBoolResourceElementsAttrGetValue(attr::MlirAttribute, pos::Cptrdiff_t)::Bool
end

function mlirDenseInt8ResourceElementsAttrGetValue(attr, pos)
    @ccall mlir_c.mlirDenseInt8ResourceElementsAttrGetValue(attr::MlirAttribute, pos::Cptrdiff_t)::Int8
end

function mlirDenseUInt8ResourceElementsAttrGetValue(attr, pos)
    @ccall mlir_c.mlirDenseUInt8ResourceElementsAttrGetValue(attr::MlirAttribute, pos::Cptrdiff_t)::UInt8
end

function mlirDenseInt16ResourceElementsAttrGetValue(attr, pos)
    @ccall mlir_c.mlirDenseInt16ResourceElementsAttrGetValue(attr::MlirAttribute, pos::Cptrdiff_t)::Int16
end

function mlirDenseUInt16ResourceElementsAttrGetValue(attr, pos)
    @ccall mlir_c.mlirDenseUInt16ResourceElementsAttrGetValue(attr::MlirAttribute, pos::Cptrdiff_t)::UInt16
end

function mlirDenseInt32ResourceElementsAttrGetValue(attr, pos)
    @ccall mlir_c.mlirDenseInt32ResourceElementsAttrGetValue(attr::MlirAttribute, pos::Cptrdiff_t)::Int32
end

function mlirDenseUInt32ResourceElementsAttrGetValue(attr, pos)
    @ccall mlir_c.mlirDenseUInt32ResourceElementsAttrGetValue(attr::MlirAttribute, pos::Cptrdiff_t)::UInt32
end

function mlirDenseInt64ResourceElementsAttrGetValue(attr, pos)
    @ccall mlir_c.mlirDenseInt64ResourceElementsAttrGetValue(attr::MlirAttribute, pos::Cptrdiff_t)::Int64
end

function mlirDenseUInt64ResourceElementsAttrGetValue(attr, pos)
    @ccall mlir_c.mlirDenseUInt64ResourceElementsAttrGetValue(attr::MlirAttribute, pos::Cptrdiff_t)::UInt64
end
...
function mlirDenseDoubleResourceElementsAttrGetValue(attr, pos)
    @ccall mlir_c.mlirDenseDoubleResourceElementsAttrGetValue(attr::MlirAttribute, pos::Cptrdiff_t)::Cdouble
end
...
function mlirStridedLayoutAttrGet(ctx, offset, numStrides, strides)
    @ccall mlir_c.mlirStridedLayoutAttrGet(ctx::MlirContext, offset::Int64, numStrides::Cptrdiff_t, strides::Ptr{Int64})::MlirAttribute
end
...
function mlirStridedLayoutAttrGetStride(attr, pos)
    @ccall mlir_c.mlirStridedLayoutAttrGetStride(attr::MlirAttribute, pos::Cptrdiff_t)::Int64
end
...
function mlirVectorTypeGet(rank, shape, elementType)
    @ccall mlir_c.mlirVectorTypeGet(rank::Cptrdiff_t, shape::Ptr{Int64}, elementType::MlirType)::MlirType
end
...
function mlirVectorTypeGetChecked(loc, rank, shape, elementType)
    @ccall mlir_c.mlirVectorTypeGetChecked(loc::MlirLocation, rank::Cptrdiff_t, shape::Ptr{Int64}, elementType::MlirType)::MlirType
end
...
function mlirVectorTypeGetScalable(rank, shape, scalable, elementType)
    @ccall mlir_c.mlirVectorTypeGetScalable(rank::Cptrdiff_t, shape::Ptr{Int64}, scalable::Ptr{Bool}, elementType::MlirType)::MlirType
end
...
function mlirVectorTypeGetScalableChecked(loc, rank, shape, scalable, elementType)
    @ccall mlir_c.mlirVectorTypeGetScalableChecked(loc::MlirLocation, rank::Cptrdiff_t, shape::Ptr{Int64}, scalable::Ptr{Bool}, elementType::MlirType)::MlirType
end
...
function mlirRankedTensorTypeGet(rank, shape, elementType, encoding)
    @ccall mlir_c.mlirRankedTensorTypeGet(rank::Cptrdiff_t, shape::Ptr{Int64}, elementType::MlirType, encoding::MlirAttribute)::MlirType
end
...
function mlirRankedTensorTypeGetChecked(loc, rank, shape, elementType, encoding)
    @ccall mlir_c.mlirRankedTensorTypeGetChecked(loc::MlirLocation, rank::Cptrdiff_t, shape::Ptr{Int64}, elementType::MlirType, encoding::MlirAttribute)::MlirType
end
...
function mlirMemRefTypeGet(elementType, rank, shape, layout, memorySpace)
    @ccall mlir_c.mlirMemRefTypeGet(elementType::MlirType, rank::Cptrdiff_t, shape::Ptr{Int64}, layout::MlirAttribute, memorySpace::MlirAttribute)::MlirType
end
...
function mlirMemRefTypeGetChecked(loc, elementType, rank, shape, layout, memorySpace)
    @ccall mlir_c.mlirMemRefTypeGetChecked(loc::MlirLocation, elementType::MlirType, rank::Cptrdiff_t, shape::Ptr{Int64}, layout::MlirAttribute, memorySpace::MlirAttribute)::MlirType
end
...
function mlirMemRefTypeContiguousGet(elementType, rank, shape, memorySpace)
    @ccall mlir_c.mlirMemRefTypeContiguousGet(elementType::MlirType, rank::Cptrdiff_t, shape::Ptr{Int64}, memorySpace::MlirAttribute)::MlirType
end
...
function mlirMemRefTypeContiguousGetChecked(loc, elementType, rank, shape, memorySpace)
    @ccall mlir_c.mlirMemRefTypeContiguousGetChecked(loc::MlirLocation, elementType::MlirType, rank::Cptrdiff_t, shape::Ptr{Int64}, memorySpace::MlirAttribute)::MlirType
end
...
function mlirTupleTypeGet(ctx, numElements, elements)
    @ccall mlir_c.mlirTupleTypeGet(ctx::MlirContext, numElements::Cptrdiff_t, elements::Ptr{MlirType})::MlirType
end
...
function mlirFunctionTypeGet(ctx, numInputs, inputs, numResults, results)
    @ccall mlir_c.mlirFunctionTypeGet(ctx::MlirContext, numInputs::Cptrdiff_t, inputs::Ptr{MlirType}, numResults::Cptrdiff_t, results::Ptr{MlirType})::MlirType
end
...
function mlirDiagnosticGetNote(diagnostic, pos)
    @ccall mlir_c.mlirDiagnosticGetNote(diagnostic::MlirDiagnostic, pos::Cptrdiff_t)::MlirDiagnostic
end
...
function mlirEmitCArrayTypeGet(nDims, shape, elementType)
    @ccall mlir_c.mlirEmitCArrayTypeGet(nDims::Cptrdiff_t, shape::Ptr{Int64}, elementType::MlirType)::MlirType
end
...
function mlirEmitCCmpPredicateAttrGet(ctx, val)
    @ccall mlir_c.mlirEmitCCmpPredicateAttrGet(ctx::MlirContext, val::MlirEmitCCmpPredicate)::MlirAttribute
end

function mlirEmitCCmpPredicateAttrGetValue(attr)
    @ccall mlir_c.mlirEmitCCmpPredicateAttrGetValue(attr::MlirAttribute)::MlirEmitCCmpPredicate
end
...
function mlirEmitCOpaqueAttrGet(ctx, value)
    @ccall mlir_c.mlirEmitCOpaqueAttrGet(ctx::MlirContext, value::MlirStringRef)::MlirAttribute
end
...
function mlirFuncSetArgAttr(op, pos, name, attr)
    @ccall mlir_c.mlirFuncSetArgAttr(op::MlirOperation, pos::Cptrdiff_t, name::MlirStringRef, attr::MlirAttribute)::Cvoid
end

function mlirFuncSetResultAttr(op, pos, name, attr)
    @ccall mlir_c.mlirFuncSetResultAttr(op::MlirOperation, pos::Cptrdiff_t, name::MlirStringRef, attr::MlirAttribute)::Cvoid
end
...
function mlirGPUObjectAttrGet(mlirCtx, target, format, objectStrRef, mlirObjectProps)
    @ccall mlir_c.mlirGPUObjectAttrGet(mlirCtx::MlirContext, target::MlirAttribute, format::UInt32, objectStrRef::MlirStringRef, mlirObjectProps::MlirAttribute)::MlirAttribute
end

function mlirGPUObjectAttrGetWithKernels(mlirCtx, target, format, objectStrRef, mlirObjectProps, mlirKernelsAttr)
    @ccall mlir_c.mlirGPUObjectAttrGetWithKernels(mlirCtx::MlirContext, target::MlirAttribute, format::UInt32, objectStrRef::MlirStringRef, mlirObjectProps::MlirAttribute, mlirKernelsAttr::MlirAttribute)::MlirAttribute
end
...
function mlirGPUObjectAttrGetProperties(mlirObjectAttr)
    @ccall mlir_c.mlirGPUObjectAttrGetProperties(mlirObjectAttr::MlirAttribute)::MlirAttribute
end
...
function mlirLLVMFunctionTypeGet(resultType, nArgumentTypes, argumentTypes, isVarArg)
    @ccall mlir_c.mlirLLVMFunctionTypeGet(resultType::MlirType, nArgumentTypes::Cptrdiff_t, argumentTypes::Ptr{MlirType}, isVarArg::Bool)::MlirType
end
...
function mlirLLVMStructTypeGetElementType(type, position)
    @ccall mlir_c.mlirLLVMStructTypeGetElementType(type::MlirType, position::Cptrdiff_t)::MlirType
end
...
function mlirLLVMStructTypeLiteralGet(ctx, nFieldTypes, fieldTypes, isPacked)
    @ccall mlir_c.mlirLLVMStructTypeLiteralGet(ctx::MlirContext, nFieldTypes::Cptrdiff_t, fieldTypes::Ptr{MlirType}, isPacked::Bool)::MlirType
end
...
function mlirLLVMStructTypeLiteralGetChecked(loc, nFieldTypes, fieldTypes, isPacked)
    @ccall mlir_c.mlirLLVMStructTypeLiteralGetChecked(loc::MlirLocation, nFieldTypes::Cptrdiff_t, fieldTypes::Ptr{MlirType}, isPacked::Bool)::MlirType
end
...
function mlirLLVMStructTypeIdentifiedNewGet(ctx, name, nFieldTypes, fieldTypes, isPacked)
    @ccall mlir_c.mlirLLVMStructTypeIdentifiedNewGet(ctx::MlirContext, name::MlirStringRef, nFieldTypes::Cptrdiff_t, fieldTypes::Ptr{MlirType}, isPacked::Bool)::MlirType
end
...
function mlirLLVMStructTypeSetBody(structType, nFieldTypes, fieldTypes, isPacked)
    @ccall mlir_c.mlirLLVMStructTypeSetBody(structType::MlirType, nFieldTypes::Cptrdiff_t, fieldTypes::Ptr{MlirType}, isPacked::Bool)::MlirLogicalResult
end
...
function mlirLLVMDIExpressionElemAttrGet(ctx, opcode, nArguments, arguments)
    @ccall mlir_c.mlirLLVMDIExpressionElemAttrGet(ctx::MlirContext, opcode::Cuint, nArguments::Cptrdiff_t, arguments::Ptr{UInt64})::MlirAttribute
end
...
function mlirLLVMDIExpressionAttrGet(ctx, nOperations, operations)
    @ccall mlir_c.mlirLLVMDIExpressionAttrGet(ctx::MlirContext, nOperations::Cptrdiff_t, operations::Ptr{MlirAttribute})::MlirAttribute
end
...
"""
function mlirLLVMDICompositeTypeAttrGet(ctx, recId, isRecSelf, tag, name, file, line, scope, baseType, flags, sizeInBits, alignInBits, nElements, elements, dataLocation, rank, allocated, associated)
    @ccall mlir_c.mlirLLVMDICompositeTypeAttrGet(ctx::MlirContext, recId::MlirAttribute, isRecSelf::Bool, tag::Cuint, name::MlirAttribute, file::MlirAttribute, line::UInt32, scope::MlirAttribute, baseType::MlirAttribute, flags::Int64, sizeInBits::UInt64, alignInBits::UInt64, nElements::Cptrdiff_t, elements::Ptr{MlirAttribute}, dataLocation::MlirAttribute, rank::MlirAttribute, allocated::MlirAttribute, associated::MlirAttribute)::MlirAttribute
end
...
"""
function mlirLLVMDIDerivedTypeAttrGet(ctx, tag, name, baseType, sizeInBits, alignInBits, offsetInBits, dwarfAddressSpace, extraData)
    @ccall mlir_c.mlirLLVMDIDerivedTypeAttrGet(ctx::MlirContext, tag::Cuint, name::MlirAttribute, baseType::MlirAttribute, sizeInBits::UInt64, alignInBits::UInt32, offsetInBits::UInt64, dwarfAddressSpace::Int64, extraData::MlirAttribute)::MlirAttribute
end

function mlirLLVMDIStringTypeAttrGet(ctx, tag, name, sizeInBits, alignInBits, stringLength, stringLengthExp, stringLocationExp, encoding)
    @ccall mlir_c.mlirLLVMDIStringTypeAttrGet(ctx::MlirContext, tag::Cuint, name::MlirAttribute, sizeInBits::UInt64, alignInBits::UInt32, stringLength::MlirAttribute, stringLengthExp::MlirAttribute, stringLocationExp::MlirAttribute, encoding::MlirLLVMTypeEncoding)::MlirAttribute
end
...
"""
function mlirLLVMDILocalVariableAttrGet(ctx, scope, name, diFile, line, arg, alignInBits, diType, flags)
    @ccall mlir_c.mlirLLVMDILocalVariableAttrGet(ctx::MlirContext, scope::MlirAttribute, name::MlirAttribute, diFile::MlirAttribute, line::Cuint, arg::Cuint, alignInBits::Cuint, diType::MlirAttribute, flags::Int64)::MlirAttribute
end
...
"""
function mlirLLVMDISubprogramAttrGet(ctx, recId, isRecSelf, id, compileUnit, scope, name, linkageName, file, line, scopeLine, subprogramFlags, type, nRetainedNodes, retainedNodes, nAnnotations, annotations)
    @ccall mlir_c.mlirLLVMDISubprogramAttrGet(ctx::MlirContext, recId::MlirAttribute, isRecSelf::Bool, id::MlirAttribute, compileUnit::MlirAttribute, scope::MlirAttribute, name::MlirAttribute, linkageName::MlirAttribute, file::MlirAttribute, line::Cuint, scopeLine::Cuint, subprogramFlags::UInt64, type::MlirAttribute, nRetainedNodes::Cptrdiff_t, retainedNodes::Ptr{MlirAttribute}, nAnnotations::Cptrdiff_t, annotations::Ptr{MlirAttribute})::MlirAttribute
end
...
function mlirLLVMDIAnnotationAttrGet(ctx, name, value)
    @ccall mlir_c.mlirLLVMDIAnnotationAttrGet(ctx::MlirContext, name::MlirAttribute, value::MlirAttribute)::MlirAttribute
end
...
function mlirLLVMDISubroutineTypeAttrGet(ctx, callingConvention, nTypes, types)
    @ccall mlir_c.mlirLLVMDISubroutineTypeAttrGet(ctx::MlirContext, callingConvention::Cuint, nTypes::Cptrdiff_t, types::Ptr{MlirAttribute})::MlirAttribute
end
...
"""
function mlirLLVMDIImportedEntityAttrGet(ctx, tag, scope, entity, file, line, name, nElements, elements)
    @ccall mlir_c.mlirLLVMDIImportedEntityAttrGet(ctx::MlirContext, tag::Cuint, scope::MlirAttribute, entity::MlirAttribute, file::MlirAttribute, line::Cuint, name::MlirAttribute, nElements::Cptrdiff_t, elements::Ptr{MlirAttribute})::MlirAttribute
end
...
function mlirLinalgInferContractionDimensions(op)
    @ccall mlir_c.mlirLinalgInferContractionDimensions(op::MlirOperation)::MlirLinalgContractionDimensions
end
...
function mlirLinalgInferConvolutionDimensions(op)
    @ccall mlir_c.mlirLinalgInferConvolutionDimensions(op::MlirOperation)::MlirLinalgConvolutionDimensions
end
...
function mlirNVGPUTensorMapDescriptorTypeGet(ctx, tensorMemrefType, swizzle, l2promo, oobFill, interleave)
    @ccall mlir_c.mlirNVGPUTensorMapDescriptorTypeGet(ctx::MlirContext, tensorMemrefType::MlirType, swizzle::Cint, l2promo::Cint, oobFill::Cint, interleave::Cint)::MlirType
end
...
function mlirUniformQuantizedPerAxisTypeGet(flags, storageType, expressedType, nDims, scales, zeroPoints, quantizedDimension, storageTypeMin, storageTypeMax)
    @ccall mlir_c.mlirUniformQuantizedPerAxisTypeGet(flags::Cuint, storageType::MlirType, expressedType::MlirType, nDims::Cptrdiff_t, scales::Ptr{Cdouble}, zeroPoints::Ptr{Int64}, quantizedDimension::Int32, storageTypeMin::Int64, storageTypeMax::Int64)::MlirType
end
...
function mlirUniformQuantizedPerAxisTypeGetScale(type, pos)
    @ccall mlir_c.mlirUniformQuantizedPerAxisTypeGetScale(type::MlirType, pos::Cptrdiff_t)::Cdouble
end
...
function mlirUniformQuantizedPerAxisTypeGetZeroPoint(type, pos)
    @ccall mlir_c.mlirUniformQuantizedPerAxisTypeGetZeroPoint(type::MlirType, pos::Cptrdiff_t)::Int64
end
...
"""
function mlirUniformQuantizedSubChannelTypeGet(flags, storageType, expressedType, scalesAttr, zeroPointsAttr, blockSizeInfoLength, quantizedDimensions, blockSizes, storageTypeMin, storageTypeMax)
    @ccall mlir_c.mlirUniformQuantizedSubChannelTypeGet(flags::Cuint, storageType::MlirType, expressedType::MlirType, scalesAttr::MlirAttribute, zeroPointsAttr::MlirAttribute, blockSizeInfoLength::Cptrdiff_t, quantizedDimensions::Ptr{Int32}, blockSizes::Ptr{Int64}, storageTypeMin::Int64, storageTypeMax::Int64)::MlirType
end
...
function mlirUniformQuantizedSubChannelTypeGetNumBlockSizes(type)
    @ccall mlir_c.mlirUniformQuantizedSubChannelTypeGetNumBlockSizes(type::MlirType)::Cptrdiff_t
end
...
function mlirUniformQuantizedSubChannelTypeGetQuantizedDimension(type, pos)
    @ccall mlir_c.mlirUniformQuantizedSubChannelTypeGetQuantizedDimension(type::MlirType, pos::Cptrdiff_t)::Int32
end
...
function mlirUniformQuantizedSubChannelTypeGetBlockSize(type, pos)
    @ccall mlir_c.mlirUniformQuantizedSubChannelTypeGetBlockSize(type::MlirType, pos::Cptrdiff_t)::Int64
end
...
function mlirSMTTypeGetArray(ctx, domainType, rangeType)
    @ccall mlir_c.mlirSMTTypeGetArray(ctx::MlirContext, domainType::MlirType, rangeType::MlirType)::MlirType
end
...
function mlirSMTTypeGetSMTFunc(ctx, numberOfDomainTypes, domainTypes, rangeType)
    @ccall mlir_c.mlirSMTTypeGetSMTFunc(ctx::MlirContext, numberOfDomainTypes::Csize_t, domainTypes::Ptr{MlirType}, rangeType::MlirType)::MlirType
end
...
function mlirSMTTypeGetSort(ctx, identifier, numberOfSortParams, sortParams)
    @ccall mlir_c.mlirSMTTypeGetSort(ctx::MlirContext, identifier::MlirIdentifier, numberOfSortParams::Csize_t, sortParams::Ptr{MlirType})::MlirType
end
...
function mlirSMTAttrGetBitVector(ctx, value, width)
    @ccall mlir_c.mlirSMTAttrGetBitVector(ctx::MlirContext, value::UInt64, width::Cuint)::MlirAttribute
end
...
function mlirSMTAttrGetBVCmpPredicate(ctx, str)
    @ccall mlir_c.mlirSMTAttrGetBVCmpPredicate(ctx::MlirContext, str::MlirStringRef)::MlirAttribute
end
...
function mlirSMTAttrGetIntPredicate(ctx, str)
    @ccall mlir_c.mlirSMTAttrGetIntPredicate(ctx::MlirContext, str::MlirStringRef)::MlirAttribute
end
...
"""
function mlirSparseTensorEncodingAttrGet(ctx, lvlRank, lvlTypes, dimToLvl, lvlTodim, posWidth, crdWidth, explicitVal, implicitVal)
    @ccall mlir_c.mlirSparseTensorEncodingAttrGet(ctx::MlirContext, lvlRank::Cptrdiff_t, lvlTypes::Ptr{MlirSparseTensorLevelType}, dimToLvl::MlirAffineMap, lvlTodim::MlirAffineMap, posWidth::Cint, crdWidth::Cint, explicitVal::MlirAttribute, implicitVal::MlirAttribute)::MlirAttribute
end
...
function mlirSparseTensorEncodingAttrGetLvlType(attr, lvl)
    @ccall mlir_c.mlirSparseTensorEncodingAttrGetLvlType(attr::MlirAttribute, lvl::Cptrdiff_t)::MlirSparseTensorLevelType
end
...
function mlirSparseTensorEncodingAttrGetLvlFmt(attr, lvl)
    @ccall mlir_c.mlirSparseTensorEncodingAttrGetLvlFmt(attr::MlirAttribute, lvl::Cptrdiff_t)::MlirSparseTensorLevelFormat
end
...
function mlirSparseTensorEncodingAttrGetExplicitVal(attr)
    @ccall mlir_c.mlirSparseTensorEncodingAttrGetExplicitVal(attr::MlirAttribute)::MlirAttribute
end
...
function mlirSparseTensorEncodingAttrGetImplicitVal(attr)
    @ccall mlir_c.mlirSparseTensorEncodingAttrGetImplicitVal(attr::MlirAttribute)::MlirAttribute
end
...
function mlirMergeSymbolsIntoFromClone(target, other)
    @ccall mlir_c.mlirMergeSymbolsIntoFromClone(target::MlirOperation, other::MlirOperation)::MlirLogicalResult
end
...
"""
function mlirPassManagerEnableIRPrinting(passManager, printBeforeAll, printAfterAll, printModuleScope, printAfterOnlyOnChange, printAfterOnlyOnFailure, flags, treePrintingPath)
    @ccall mlir_c.mlirPassManagerEnableIRPrinting(passManager::MlirPassManager, printBeforeAll::Bool, printAfterAll::Bool, printModuleScope::Bool, printAfterOnlyOnChange::Bool, printAfterOnlyOnFailure::Bool, flags::MlirOpPrintingFlags, treePrintingPath::MlirStringRef)::Cvoid
end
...
function mlirCreateExternalPass(passID, name, argument, description, opName, nDependentDialects, dependentDialects, callbacks, userData)
    @ccall mlir_c.mlirCreateExternalPass(passID::MlirTypeID, name::MlirStringRef, argument::MlirStringRef, description::MlirStringRef, opName::MlirStringRef, nDependentDialects::Cptrdiff_t, dependentDialects::Ptr{MlirDialectHandle}, callbacks::MlirExternalPassCallbacks, userData::Ptr{Cvoid})::MlirPass
end
...
function mlirRewriterBaseSetInsertionPointBefore(rewriter, op)
    @ccall mlir_c.mlirRewriterBaseSetInsertionPointBefore(rewriter::MlirRewriterBase, op::MlirOperation)::Cvoid
end
...
function mlirRewriterBaseSetInsertionPointAfter(rewriter, op)
    @ccall mlir_c.mlirRewriterBaseSetInsertionPointAfter(rewriter::MlirRewriterBase, op::MlirOperation)::Cvoid
end
...
function mlirRewriterBaseSetInsertionPointAfterValue(rewriter, value)
    @ccall mlir_c.mlirRewriterBaseSetInsertionPointAfterValue(rewriter::MlirRewriterBase, value::MlirValue)::Cvoid
end
...
function mlirRewriterBaseSetInsertionPointToStart(rewriter, block)
    @ccall mlir_c.mlirRewriterBaseSetInsertionPointToStart(rewriter::MlirRewriterBase, block::MlirBlock)::Cvoid
end
...
function mlirRewriterBaseSetInsertionPointToEnd(rewriter, block)
    @ccall mlir_c.mlirRewriterBaseSetInsertionPointToEnd(rewriter::MlirRewriterBase, block::MlirBlock)::Cvoid
end
...
"""
function mlirRewriterBaseCreateBlockBefore(rewriter, insertBefore, nArgTypes, argTypes, locations)
    @ccall mlir_c.mlirRewriterBaseCreateBlockBefore(rewriter::MlirRewriterBase, insertBefore::MlirBlock, nArgTypes::Cptrdiff_t, argTypes::Ptr{MlirType}, locations::Ptr{MlirLocation})::MlirBlock
end
...
function mlirRewriterBaseInsert(rewriter, op)
    @ccall mlir_c.mlirRewriterBaseInsert(rewriter::MlirRewriterBase, op::MlirOperation)::MlirOperation
end
...
function mlirRewriterBaseClone(rewriter, op)
    @ccall mlir_c.mlirRewriterBaseClone(rewriter::MlirRewriterBase, op::MlirOperation)::MlirOperation
end
...
function mlirRewriterBaseCloneWithoutRegions(rewriter, op)
    @ccall mlir_c.mlirRewriterBaseCloneWithoutRegions(rewriter::MlirRewriterBase, op::MlirOperation)::MlirOperation
end
...
function mlirRewriterBaseCloneRegionBefore(rewriter, region, before)
    @ccall mlir_c.mlirRewriterBaseCloneRegionBefore(rewriter::MlirRewriterBase, region::MlirRegion, before::MlirBlock)::Cvoid
end
...
function mlirRewriterBaseInlineRegionBefore(rewriter, region, before)
    @ccall mlir_c.mlirRewriterBaseInlineRegionBefore(rewriter::MlirRewriterBase, region::MlirRegion, before::MlirBlock)::Cvoid
end
...
function mlirRewriterBaseReplaceOpWithValues(rewriter, op, nValues, values)
    @ccall mlir_c.mlirRewriterBaseReplaceOpWithValues(rewriter::MlirRewriterBase, op::MlirOperation, nValues::Cptrdiff_t, values::Ptr{MlirValue})::Cvoid
end
...
function mlirRewriterBaseReplaceOpWithOperation(rewriter, op, newOp)
    @ccall mlir_c.mlirRewriterBaseReplaceOpWithOperation(rewriter::MlirRewriterBase, op::MlirOperation, newOp::MlirOperation)::Cvoid
end
...
function mlirRewriterBaseEraseOp(rewriter, op)
    @ccall mlir_c.mlirRewriterBaseEraseOp(rewriter::MlirRewriterBase, op::MlirOperation)::Cvoid
end
...
function mlirRewriterBaseEraseBlock(rewriter, block)
    @ccall mlir_c.mlirRewriterBaseEraseBlock(rewriter::MlirRewriterBase, block::MlirBlock)::Cvoid
end
...
function mlirRewriterBaseInlineBlockBefore(rewriter, source, op, nArgValues, argValues)
    @ccall mlir_c.mlirRewriterBaseInlineBlockBefore(rewriter::MlirRewriterBase, source::MlirBlock, op::MlirOperation, nArgValues::Cptrdiff_t, argValues::Ptr{MlirValue})::Cvoid
end
...
function mlirRewriterBaseMergeBlocks(rewriter, source, dest, nArgValues, argValues)
    @ccall mlir_c.mlirRewriterBaseMergeBlocks(rewriter::MlirRewriterBase, source::MlirBlock, dest::MlirBlock, nArgValues::Cptrdiff_t, argValues::Ptr{MlirValue})::Cvoid
end
...
function mlirRewriterBaseMoveOpBefore(rewriter, op, existingOp)
    @ccall mlir_c.mlirRewriterBaseMoveOpBefore(rewriter::MlirRewriterBase, op::MlirOperation, existingOp::MlirOperation)::Cvoid
end
...
function mlirRewriterBaseMoveOpAfter(rewriter, op, existingOp)
    @ccall mlir_c.mlirRewriterBaseMoveOpAfter(rewriter::MlirRewriterBase, op::MlirOperation, existingOp::MlirOperation)::Cvoid
end
...
function mlirRewriterBaseMoveBlockBefore(rewriter, block, existingBlock)
    @ccall mlir_c.mlirRewriterBaseMoveBlockBefore(rewriter::MlirRewriterBase, block::MlirBlock, existingBlock::MlirBlock)::Cvoid
end
...
function mlirRewriterBaseStartOpModification(rewriter, op)
    @ccall mlir_c.mlirRewriterBaseStartOpModification(rewriter::MlirRewriterBase, op::MlirOperation)::Cvoid
end
...
function mlirRewriterBaseFinalizeOpModification(rewriter, op)
    @ccall mlir_c.mlirRewriterBaseFinalizeOpModification(rewriter::MlirRewriterBase, op::MlirOperation)::Cvoid
end
...
function mlirRewriterBaseCancelOpModification(rewriter, op)
    @ccall mlir_c.mlirRewriterBaseCancelOpModification(rewriter::MlirRewriterBase, op::MlirOperation)::Cvoid
end
...
function mlirRewriterBaseReplaceAllUsesWith(rewriter, from, to)
    @ccall mlir_c.mlirRewriterBaseReplaceAllUsesWith(rewriter::MlirRewriterBase, from::MlirValue, to::MlirValue)::Cvoid
end
...
function mlirRewriterBaseReplaceAllValueRangeUsesWith(rewriter, nValues, from, to)
    @ccall mlir_c.mlirRewriterBaseReplaceAllValueRangeUsesWith(rewriter::MlirRewriterBase, nValues::Cptrdiff_t, from::Ptr{MlirValue}, to::Ptr{MlirValue})::Cvoid
end
...
function mlirRewriterBaseReplaceAllOpUsesWithValueRange(rewriter, from, nTo, to)
    @ccall mlir_c.mlirRewriterBaseReplaceAllOpUsesWithValueRange(rewriter::MlirRewriterBase, from::MlirOperation, nTo::Cptrdiff_t, to::Ptr{MlirValue})::Cvoid
end
...
function mlirRewriterBaseReplaceAllOpUsesWithOperation(rewriter, from, to)
    @ccall mlir_c.mlirRewriterBaseReplaceAllOpUsesWithOperation(rewriter::MlirRewriterBase, from::MlirOperation, to::MlirOperation)::Cvoid
end
...
"""
function mlirRewriterBaseReplaceOpUsesWithinBlock(rewriter, op, nNewValues, newValues, block)
    @ccall mlir_c.mlirRewriterBaseReplaceOpUsesWithinBlock(rewriter::MlirRewriterBase, op::MlirOperation, nNewValues::Cptrdiff_t, newValues::Ptr{MlirValue}, block::MlirBlock)::Cvoid
end
...
function mlirRewriterBaseReplaceAllUsesExcept(rewriter, from, to, exceptedUser)
    @ccall mlir_c.mlirRewriterBaseReplaceAllUsesExcept(rewriter::MlirRewriterBase, from::MlirValue, to::MlirValue, exceptedUser::MlirOperation)::Cvoid
end
...
function mlirApplyPatternsAndFoldGreedilyWithOp(op, patterns, arg3)
    @ccall mlir_c.mlirApplyPatternsAndFoldGreedilyWithOp(op::MlirOperation, patterns::MlirFrozenRewritePatternSet, arg3::MlirGreedyRewriteDriverConfig)::MlirLogicalResult
end

function mlirApplyPatternsAndFoldGreedily(op, patterns, arg3)
    @ccall mlir_c.mlirApplyPatternsAndFoldGreedily(op::MlirModule, patterns::MlirFrozenRewritePatternSet, arg3::MlirGreedyRewriteDriverConfig)::MlirLogicalResult
end
...
"""
function mlirTranslateModuleToSMTLIB(arg1, arg2, userData, inlineSingleUseValues, indentLetBody)
    @ccall mlir_c.mlirTranslateModuleToSMTLIB(arg1::MlirModule, arg2::MlirStringCallback, userData::Ptr{Cvoid}, inlineSingleUseValues::Bool, indentLetBody::Bool)::MlirLogicalResult
end

function mlirTranslateOperationToSMTLIB(arg1, arg2, userData, inlineSingleUseValues, indentLetBody)
    @ccall mlir_c.mlirTranslateOperationToSMTLIB(arg1::MlirOperation, arg2::MlirStringCallback, userData::Ptr{Cvoid}, inlineSingleUseValues::Bool, indentLetBody::Bool)::MlirLogicalResult
end
...
function LLVMParseCommandLineOptions(argc, argv, Overview)
    @ccall mlir_c.LLVMParseCommandLineOptions(argc::Cint, argv::Ptr{Cstring}, Overview::Cstring)::Cint
end
...
function mlirTypeFromLLVMIRTranslatorCreate(ctx)
    @ccall mlir_c.mlirTypeFromLLVMIRTranslatorCreate(ctx::MlirContext)::MlirTypeFromLLVMIRTranslator
end
...
function mlirTypeFromLLVMIRTranslatorDestroy(translator)
    @ccall mlir_c.mlirTypeFromLLVMIRTranslatorDestroy(translator::MlirTypeFromLLVMIRTranslator)::Cvoid
end
...
function mlirTypeFromLLVMIRTranslatorTranslateType(translator, llvmType)
    @ccall mlir_c.mlirTypeFromLLVMIRTranslatorTranslateType(translator::MlirTypeFromLLVMIRTranslator, llvmType::LLVMTypeRef)::MlirType
end
...
function mlirTypeToLLVMIRTranslatorCreate(ctx)
    @ccall mlir_c.mlirTypeToLLVMIRTranslatorCreate(ctx::LLVMContextRef)::MlirTypeToLLVMIRTranslator
end
...
function mlirTypeToLLVMIRTranslatorDestroy(translator)
    @ccall mlir_c.mlirTypeToLLVMIRTranslatorDestroy(translator::MlirTypeToLLVMIRTranslator)::Cvoid
end
...
function mlirTypeToLLVMIRTranslatorTranslateType(translator, mlirType)
    @ccall mlir_c.mlirTypeToLLVMIRTranslatorTranslateType(translator::MlirTypeToLLVMIRTranslator, mlirType::MlirType)::LLVMTypeRef
end

function stablehloScatterDimensionNumbersGet(ctx, nUpdateWindowDims, updateWindowDims, nInsertedWindowDims, insertedWindowDims, nInputBatchingDims, inputBatchingDims, nScatterIndicesBatchingDims, scatterIndicesBatchingDims, nScatteredDimsToOperandDims, scatteredDimsToOperandDims, indexVectorDim)
    @ccall mlir_c.stablehloScatterDimensionNumbersGet(ctx::MlirContext, nUpdateWindowDims::Cptrdiff_t, updateWindowDims::Ptr{Int64}, nInsertedWindowDims::Cptrdiff_t, insertedWindowDims::Ptr{Int64}, nInputBatchingDims::Cptrdiff_t, inputBatchingDims::Ptr{Int64}, nScatterIndicesBatchingDims::Cptrdiff_t, scatterIndicesBatchingDims::Ptr{Int64}, nScatteredDimsToOperandDims::Cptrdiff_t, scatteredDimsToOperandDims::Ptr{Int64}, indexVectorDim::Int64)::MlirAttribute
end
...
function stablehloScatterDimensionNumbersGetUpdateWindowDimsSize(attr)
    @ccall mlir_c.stablehloScatterDimensionNumbersGetUpdateWindowDimsSize(attr::MlirAttribute)::Cptrdiff_t
end

function stablehloScatterDimensionNumbersGetUpdateWindowDimsElem(attr, pos)
    @ccall mlir_c.stablehloScatterDimensionNumbersGetUpdateWindowDimsElem(attr::MlirAttribute, pos::Cptrdiff_t)::Int64
end

function stablehloScatterDimensionNumbersGetInsertedWindowDimsSize(attr)
    @ccall mlir_c.stablehloScatterDimensionNumbersGetInsertedWindowDimsSize(attr::MlirAttribute)::Cptrdiff_t
end

function stablehloScatterDimensionNumbersGetInsertedWindowDimsElem(attr, pos)
    @ccall mlir_c.stablehloScatterDimensionNumbersGetInsertedWindowDimsElem(attr::MlirAttribute, pos::Cptrdiff_t)::Int64
end

function stablehloScatterDimensionNumbersGetInputBatchingDimsSize(attr)
    @ccall mlir_c.stablehloScatterDimensionNumbersGetInputBatchingDimsSize(attr::MlirAttribute)::Cptrdiff_t
end

function stablehloScatterDimensionNumbersGetInputBatchingDimsElem(attr, pos)
    @ccall mlir_c.stablehloScatterDimensionNumbersGetInputBatchingDimsElem(attr::MlirAttribute, pos::Cptrdiff_t)::Int64
end

function stablehloScatterDimensionNumbersGetScatterIndicesBatchingDimsSize(attr)
    @ccall mlir_c.stablehloScatterDimensionNumbersGetScatterIndicesBatchingDimsSize(attr::MlirAttribute)::Cptrdiff_t
end

function stablehloScatterDimensionNumbersGetScatterIndicesBatchingDimsElem(attr, pos)
    @ccall mlir_c.stablehloScatterDimensionNumbersGetScatterIndicesBatchingDimsElem(attr::MlirAttribute, pos::Cptrdiff_t)::Int64
end

function stablehloScatterDimensionNumbersGetScatteredDimsToOperandDimsSize(attr)
    @ccall mlir_c.stablehloScatterDimensionNumbersGetScatteredDimsToOperandDimsSize(attr::MlirAttribute)::Cptrdiff_t
end

function stablehloScatterDimensionNumbersGetScatteredDimsToOperandDimsElem(attr, pos)
    @ccall mlir_c.stablehloScatterDimensionNumbersGetScatteredDimsToOperandDimsElem(attr::MlirAttribute, pos::Cptrdiff_t)::Int64
end
...
function stablehloGatherDimensionNumbersGet(ctx, nOffsetDims, offsetDims, nCollapsedSliceDims, collapsedSliceDims, nOperandBatchingDims, operandBatchingDims, nStartIndicesBatchingDims, startIndicesBatchingDims, nStartIndexMap, startIndexMap, indexVectorDim)
    @ccall mlir_c.stablehloGatherDimensionNumbersGet(ctx::MlirContext, nOffsetDims::Cptrdiff_t, offsetDims::Ptr{Int64}, nCollapsedSliceDims::Cptrdiff_t, collapsedSliceDims::Ptr{Int64}, nOperandBatchingDims::Cptrdiff_t, operandBatchingDims::Ptr{Int64}, nStartIndicesBatchingDims::Cptrdiff_t, startIndicesBatchingDims::Ptr{Int64}, nStartIndexMap::Cptrdiff_t, startIndexMap::Ptr{Int64}, indexVectorDim::Int64)::MlirAttribute
end
...
function stablehloGatherDimensionNumbersGetOffsetDimsSize(attr)
    @ccall mlir_c.stablehloGatherDimensionNumbersGetOffsetDimsSize(attr::MlirAttribute)::Cptrdiff_t
end

function stablehloGatherDimensionNumbersGetOffsetDimsElem(attr, pos)
    @ccall mlir_c.stablehloGatherDimensionNumbersGetOffsetDimsElem(attr::MlirAttribute, pos::Cptrdiff_t)::Int64
end

function stablehloGatherDimensionNumbersGetCollapsedSliceDimsSize(attr)
    @ccall mlir_c.stablehloGatherDimensionNumbersGetCollapsedSliceDimsSize(attr::MlirAttribute)::Cptrdiff_t
end

function stablehloGatherDimensionNumbersGetCollapsedSliceDimsElem(attr, pos)
    @ccall mlir_c.stablehloGatherDimensionNumbersGetCollapsedSliceDimsElem(attr::MlirAttribute, pos::Cptrdiff_t)::Int64
end

function stablehloGatherDimensionNumbersGetOperandBatchingDimsSize(attr)
    @ccall mlir_c.stablehloGatherDimensionNumbersGetOperandBatchingDimsSize(attr::MlirAttribute)::Cptrdiff_t
end

function stablehloGatherDimensionNumbersGetOperandBatchingDimsElem(attr, pos)
    @ccall mlir_c.stablehloGatherDimensionNumbersGetOperandBatchingDimsElem(attr::MlirAttribute, pos::Cptrdiff_t)::Int64
end

function stablehloGatherDimensionNumbersGetStartIndicesBatchingDimsSize(attr)
    @ccall mlir_c.stablehloGatherDimensionNumbersGetStartIndicesBatchingDimsSize(attr::MlirAttribute)::Cptrdiff_t
end

function stablehloGatherDimensionNumbersGetStartIndicesBatchingDimsElem(attr, pos)
    @ccall mlir_c.stablehloGatherDimensionNumbersGetStartIndicesBatchingDimsElem(attr::MlirAttribute, pos::Cptrdiff_t)::Int64
end

function stablehloGatherDimensionNumbersGetStartIndexMapSize(attr)
    @ccall mlir_c.stablehloGatherDimensionNumbersGetStartIndexMapSize(attr::MlirAttribute)::Cptrdiff_t
end

function stablehloGatherDimensionNumbersGetStartIndexMapElem(attr, pos)
    @ccall mlir_c.stablehloGatherDimensionNumbersGetStartIndexMapElem(attr::MlirAttribute, pos::Cptrdiff_t)::Int64
end
...
function stablehloDotAlgorithmGet(ctx, lhsPrecisionType, rhsPrecisionType, accumulationType, lhsComponentCount, rhsComponentCount, numPrimitiveOperations, allowImpreciseAccumulation)
    @ccall mlir_c.stablehloDotAlgorithmGet(ctx::MlirContext, lhsPrecisionType::MlirType, rhsPrecisionType::MlirType, accumulationType::MlirType, lhsComponentCount::Int64, rhsComponentCount::Int64, numPrimitiveOperations::Int64, allowImpreciseAccumulation::Bool)::MlirAttribute
end
...
function stablehloDotAlgorithmGetAllowImpreciseAccumulation(attr)
    @ccall mlir_c.stablehloDotAlgorithmGetAllowImpreciseAccumulation(attr::MlirAttribute)::Bool
end
...
function stablehloDotDimensionNumbersGet(ctx, nLhsBatchingDimensions, lhsBatchingDimensions, nRhsBatchingDimensions, rhsBatchingDimensions, nLhsContractingDimensions, lhsContractingDimensions, nRhsContractingDimensions, rhsContractingDimensions)
    @ccall mlir_c.stablehloDotDimensionNumbersGet(ctx::MlirContext, nLhsBatchingDimensions::Cptrdiff_t, lhsBatchingDimensions::Ptr{Int64}, nRhsBatchingDimensions::Cptrdiff_t, rhsBatchingDimensions::Ptr{Int64}, nLhsContractingDimensions::Cptrdiff_t, lhsContractingDimensions::Ptr{Int64}, nRhsContractingDimensions::Cptrdiff_t, rhsContractingDimensions::Ptr{Int64})::MlirAttribute
end
...
function stablehloDotDimensionNumbersGetLhsBatchingDimensionsSize(attr)
    @ccall mlir_c.stablehloDotDimensionNumbersGetLhsBatchingDimensionsSize(attr::MlirAttribute)::Cptrdiff_t
end

function stablehloDotDimensionNumbersGetLhsBatchingDimensionsElem(attr, pos)
    @ccall mlir_c.stablehloDotDimensionNumbersGetLhsBatchingDimensionsElem(attr::MlirAttribute, pos::Cptrdiff_t)::Int64
end

function stablehloDotDimensionNumbersGetRhsBatchingDimensionsSize(attr)
    @ccall mlir_c.stablehloDotDimensionNumbersGetRhsBatchingDimensionsSize(attr::MlirAttribute)::Cptrdiff_t
end

function stablehloDotDimensionNumbersGetRhsBatchingDimensionsElem(attr, pos)
    @ccall mlir_c.stablehloDotDimensionNumbersGetRhsBatchingDimensionsElem(attr::MlirAttribute, pos::Cptrdiff_t)::Int64
end

function stablehloDotDimensionNumbersGetLhsContractingDimensionsSize(attr)
    @ccall mlir_c.stablehloDotDimensionNumbersGetLhsContractingDimensionsSize(attr::MlirAttribute)::Cptrdiff_t
end

function stablehloDotDimensionNumbersGetLhsContractingDimensionsElem(attr, pos)
    @ccall mlir_c.stablehloDotDimensionNumbersGetLhsContractingDimensionsElem(attr::MlirAttribute, pos::Cptrdiff_t)::Int64
end

function stablehloDotDimensionNumbersGetRhsContractingDimensionsSize(attr)
    @ccall mlir_c.stablehloDotDimensionNumbersGetRhsContractingDimensionsSize(attr::MlirAttribute)::Cptrdiff_t
end

function stablehloDotDimensionNumbersGetRhsContractingDimensionsElem(attr, pos)
    @ccall mlir_c.stablehloDotDimensionNumbersGetRhsContractingDimensionsElem(attr::MlirAttribute, pos::Cptrdiff_t)::Int64
end
...
function stablehloConvDimensionNumbersGetInputSpatialDimensionsSize(attr)
    @ccall mlir_c.stablehloConvDimensionNumbersGetInputSpatialDimensionsSize(attr::MlirAttribute)::Cptrdiff_t
end

function stablehloConvDimensionNumbersGetInputSpatialDimensionsElem(attr, pos)
    @ccall mlir_c.stablehloConvDimensionNumbersGetInputSpatialDimensionsElem(attr::MlirAttribute, pos::Cptrdiff_t)::Int64
end
...
function stablehloConvDimensionNumbersGetKernelSpatialDimensionsSize(attr)
    @ccall mlir_c.stablehloConvDimensionNumbersGetKernelSpatialDimensionsSize(attr::MlirAttribute)::Cptrdiff_t
end

function stablehloConvDimensionNumbersGetKernelSpatialDimensionsElem(attr, pos)
    @ccall mlir_c.stablehloConvDimensionNumbersGetKernelSpatialDimensionsElem(attr::MlirAttribute, pos::Cptrdiff_t)::Int64
end
...
function stablehloConvDimensionNumbersGetOutputSpatialDimensionsSize(attr)
    @ccall mlir_c.stablehloConvDimensionNumbersGetOutputSpatialDimensionsSize(attr::MlirAttribute)::Cptrdiff_t
end

function stablehloConvDimensionNumbersGetOutputSpatialDimensionsElem(attr, pos)
    @ccall mlir_c.stablehloConvDimensionNumbersGetOutputSpatialDimensionsElem(attr::MlirAttribute, pos::Cptrdiff_t)::Int64
end
...
function stablehloOutputOperandAliasGet(ctx, nOutputTupleIndices, outputTupleIndices, operandIndex, nOperandTupleIndices, operandTupleIndices)
    @ccall mlir_c.stablehloOutputOperandAliasGet(ctx::MlirContext, nOutputTupleIndices::Cptrdiff_t, outputTupleIndices::Ptr{Int64}, operandIndex::Int64, nOperandTupleIndices::Cptrdiff_t, operandTupleIndices::Ptr{Int64})::MlirAttribute
end
...
function stablehloOutputOperandAliasGetOutputTupleIndicesSize(attr)
    @ccall mlir_c.stablehloOutputOperandAliasGetOutputTupleIndicesSize(attr::MlirAttribute)::Cptrdiff_t
end

function stablehloOutputOperandAliasGetOutputTupleIndicesElem(attr, pos)
    @ccall mlir_c.stablehloOutputOperandAliasGetOutputTupleIndicesElem(attr::MlirAttribute, pos::Cptrdiff_t)::Int64
end
...
function stablehloOutputOperandAliasGetOperandTupleIndicesSize(attr)
    @ccall mlir_c.stablehloOutputOperandAliasGetOperandTupleIndicesSize(attr::MlirAttribute)::Cptrdiff_t
end

function stablehloOutputOperandAliasGetOperandTupleIndicesElem(attr, pos)
    @ccall mlir_c.stablehloOutputOperandAliasGetOperandTupleIndicesElem(attr::MlirAttribute, pos::Cptrdiff_t)::Int64
end
...
function stablehloTypeExtensionsGet(ctx, nBounds, bounds)
    @ccall mlir_c.stablehloTypeExtensionsGet(ctx::MlirContext, nBounds::Cptrdiff_t, bounds::Ptr{Int64})::MlirAttribute
end
...
function stablehloTypeExtensionsGetBoundsElem(attr, pos)
    @ccall mlir_c.stablehloTypeExtensionsGetBoundsElem(attr::MlirAttribute, pos::Cptrdiff_t)::Int64
end

function stablehloResultAccuracyModeAttrGet(ctx, value)
    @ccall mlir_c.stablehloResultAccuracyModeAttrGet(ctx::MlirContext, value::MlirStringRef)::MlirAttribute
end
...
function stablehloResultAccuracyModeAttrGetValue(attr)
    @ccall mlir_c.stablehloResultAccuracyModeAttrGetValue(attr::MlirAttribute)::MlirStringRef
end

function stablehloResultAccuracyAttrGet(ctx, atol, rtol, ulps, value)
    @ccall mlir_c.stablehloResultAccuracyAttrGet(ctx::MlirContext, atol::Cdouble, rtol::Cdouble, ulps::Int64, value::MlirStringRef)::MlirAttribute
end
...
function stablehloVersionFromCompatibilityRequirement(requirement, callback, userData)
    @ccall mlir_c.stablehloVersionFromCompatibilityRequirement(requirement::MlirStablehloCompatibilityRequirement, callback::MlirStringCallback, userData::Ptr{Cvoid})::Cvoid
end

function stablehloGetCurrentVersion(callback, userData)
    @ccall mlir_c.stablehloGetCurrentVersion(callback::MlirStringCallback, userData::Ptr{Cvoid})::Cvoid
end

function stablehloGetMinimumVersion(callback, userData)
    @ccall mlir_c.stablehloGetMinimumVersion(callback::MlirStringCallback, userData::Ptr{Cvoid})::Cvoid
end

function stablehloGetSmallerVersion(version1, version2, callback, userData)
    @ccall mlir_c.stablehloGetSmallerVersion(version1::MlirStringRef, version2::MlirStringRef, callback::MlirStringCallback, userData::Ptr{Cvoid})::MlirLogicalResult
end

function stablehloSerializePortableArtifactFromStringRef(moduleStr, targetVersion, callback, userData)
    @ccall mlir_c.stablehloSerializePortableArtifactFromStringRef(moduleStr::MlirStringRef, targetVersion::MlirStringRef, callback::MlirStringCallback, userData::Ptr{Cvoid})::MlirLogicalResult
end

function stablehloSerializePortableArtifactFromModule(moduleStr, targetVersion, callback, userData, allowOtherDialects)
    @ccall mlir_c.stablehloSerializePortableArtifactFromModule(moduleStr::MlirModule, targetVersion::MlirStringRef, callback::MlirStringCallback, userData::Ptr{Cvoid}, allowOtherDialects::Bool)::MlirLogicalResult
end
...
function stablehloDeserializePortableArtifactNoError(artifactStr, ctx)
    @ccall mlir_c.stablehloDeserializePortableArtifactNoError(artifactStr::MlirStringRef, ctx::MlirContext)::MlirModule
end
...
function sdyMeshAxisAttrGet(ctx, name, size)
    @ccall mlir_c.sdyMeshAxisAttrGet(ctx::MlirContext, name::MlirStringRef, size::Int64)::MlirAttribute
end
...
function sdyMeshAttrGet(ctx, nAxes, axes, nDeviceIds, deviceIds)
    @ccall mlir_c.sdyMeshAttrGet(ctx::MlirContext, nAxes::Cptrdiff_t, axes::Ptr{MlirAttribute}, nDeviceIds::Cptrdiff_t, deviceIds::Ptr{Int64})::MlirAttribute
end
...
function sdyMeshAttrGetAxesElem(attr, pos)
    @ccall mlir_c.sdyMeshAttrGetAxesElem(attr::MlirAttribute, pos::Cptrdiff_t)::MlirAttribute
end
...
function sdySubAxisInfoAttrGet(ctx, preSize, size)
    @ccall mlir_c.sdySubAxisInfoAttrGet(ctx::MlirContext, preSize::Int64, size::Int64)::MlirAttribute
end
...
function sdyAxisRefAttrGet(ctx, name, subAxisInfo)
    @ccall mlir_c.sdyAxisRefAttrGet(ctx::MlirContext, name::MlirStringRef, subAxisInfo::MlirAttribute)::MlirAttribute
end
...
function sdyDimensionShardingAttrGet(ctx, nAxes, axes, isClosed, priority)
    @ccall mlir_c.sdyDimensionShardingAttrGet(ctx::MlirContext, nAxes::Cptrdiff_t, axes::Ptr{MlirAttribute}, isClosed::Bool, priority::Int64)::MlirAttribute
end
...
function sdyDimensionShardingAttrGetAxesElem(attr, pos)
    @ccall mlir_c.sdyDimensionShardingAttrGetAxesElem(attr::MlirAttribute, pos::Cptrdiff_t)::MlirAttribute
end
...
function sdyTensorShardingAttrGet(ctx, meshOrRef, nDimShardings, dimShardings, nReplicatedAxes, replicatedAxes, nUnreducedAxes, unreducedAxes)
    @ccall mlir_c.sdyTensorShardingAttrGet(ctx::MlirContext, meshOrRef::MlirAttribute, nDimShardings::Cptrdiff_t, dimShardings::Ptr{MlirAttribute}, nReplicatedAxes::Cptrdiff_t, replicatedAxes::Ptr{MlirAttribute}, nUnreducedAxes::Cptrdiff_t, unreducedAxes::Ptr{MlirAttribute})::MlirAttribute
end
...
function sdyTensorShardingAttrGetDimShardingsElem(attr, pos)
    @ccall mlir_c.sdyTensorShardingAttrGetDimShardingsElem(attr::MlirAttribute, pos::Cptrdiff_t)::MlirAttribute
end

function sdyTensorShardingAttrGetReplicatedAxesSize(attr)
    @ccall mlir_c.sdyTensorShardingAttrGetReplicatedAxesSize(attr::MlirAttribute)::Cptrdiff_t
end

function sdyTensorShardingAttrGetReplicatedAxesElem(attr, pos)
    @ccall mlir_c.sdyTensorShardingAttrGetReplicatedAxesElem(attr::MlirAttribute, pos::Cptrdiff_t)::MlirAttribute
end
...
function sdyTensorShardingAttrGetUnreducedAxesElem(attr, pos)
    @ccall mlir_c.sdyTensorShardingAttrGetUnreducedAxesElem(attr::MlirAttribute, pos::Cptrdiff_t)::MlirAttribute
end
...
function sdyTensorShardingPerValueAttrGet(ctx, nShardings, shardings)
    @ccall mlir_c.sdyTensorShardingPerValueAttrGet(ctx::MlirContext, nShardings::Cptrdiff_t, shardings::Ptr{MlirAttribute})::MlirAttribute
end

function sdyTensorShardingPerValueAttrGetShardingsSize(attr)
    @ccall mlir_c.sdyTensorShardingPerValueAttrGetShardingsSize(attr::MlirAttribute)::Cptrdiff_t
end

function sdyTensorShardingPerValueAttrGetShardingsElem(attr, pos)
    @ccall mlir_c.sdyTensorShardingPerValueAttrGetShardingsElem(attr::MlirAttribute, pos::Cptrdiff_t)::MlirAttribute
end
...
function sdyDimMappingAttrGet(ctx, nFactorIndices, factorIndices)
    @ccall mlir_c.sdyDimMappingAttrGet(ctx::MlirContext, nFactorIndices::Cptrdiff_t, factorIndices::Ptr{Int64})::MlirAttribute
end
...
function sdyDimMappingAttrGetFactorIndicesElem(attr, pos)
    @ccall mlir_c.sdyDimMappingAttrGetFactorIndicesElem(attr::MlirAttribute, pos::Cptrdiff_t)::Int64
end
...
function sdyTensorMappingAttrGet(ctx, nMappings, mappings)
    @ccall mlir_c.sdyTensorMappingAttrGet(ctx::MlirContext, nMappings::Cptrdiff_t, mappings::Ptr{MlirAttribute})::MlirAttribute
end
...
function sdyTensorMappingAttrGetDimMappingsElem(attr, pos)
    @ccall mlir_c.sdyTensorMappingAttrGetDimMappingsElem(attr::MlirAttribute, pos::Cptrdiff_t)::MlirAttribute
end
...
function sdyOpShardingRuleAttrGetFactorSizesElem(attr, pos)
    @ccall mlir_c.sdyOpShardingRuleAttrGetFactorSizesElem(attr::MlirAttribute, pos::Cptrdiff_t)::Int64
end

function sdyOpShardingRuleAttrGetOperandMappingsSize(attr)
    @ccall mlir_c.sdyOpShardingRuleAttrGetOperandMappingsSize(attr::MlirAttribute)::Cptrdiff_t
end

function sdyOpShardingRuleAttrGetOperandMappingsElem(attr, pos)
    @ccall mlir_c.sdyOpShardingRuleAttrGetOperandMappingsElem(attr::MlirAttribute, pos::Cptrdiff_t)::MlirAttribute
end

function sdyOpShardingRuleAttrGetResultMappingsSize(attr)
    @ccall mlir_c.sdyOpShardingRuleAttrGetResultMappingsSize(attr::MlirAttribute)::Cptrdiff_t
end

function sdyOpShardingRuleAttrGetResultMappingsElem(attr, pos)
    @ccall mlir_c.sdyOpShardingRuleAttrGetResultMappingsElem(attr::MlirAttribute, pos::Cptrdiff_t)::MlirAttribute
end

function sdyOpShardingRuleAttrGetReductionFactorsSize(attr)
    @ccall mlir_c.sdyOpShardingRuleAttrGetReductionFactorsSize(attr::MlirAttribute)::Cptrdiff_t
end

function sdyOpShardingRuleAttrGetReductionFactorsElem(attr, pos)
    @ccall mlir_c.sdyOpShardingRuleAttrGetReductionFactorsElem(attr::MlirAttribute, pos::Cptrdiff_t)::Int64
end

function sdyOpShardingRuleAttrGetNeedReplicationFactorsSize(attr)
    @ccall mlir_c.sdyOpShardingRuleAttrGetNeedReplicationFactorsSize(attr::MlirAttribute)::Cptrdiff_t
end

function sdyOpShardingRuleAttrGetNeedReplicationFactorsElem(attr, pos)
    @ccall mlir_c.sdyOpShardingRuleAttrGetNeedReplicationFactorsElem(attr::MlirAttribute, pos::Cptrdiff_t)::Int64
end

function sdyOpShardingRuleAttrGetPermutationFactorsSize(attr)
    @ccall mlir_c.sdyOpShardingRuleAttrGetPermutationFactorsSize(attr::MlirAttribute)::Cptrdiff_t
end

function sdyOpShardingRuleAttrGetPermutationFactorsElem(attr, pos)
    @ccall mlir_c.sdyOpShardingRuleAttrGetPermutationFactorsElem(attr::MlirAttribute, pos::Cptrdiff_t)::Int64
end

function sdyOpShardingRuleAttrGetBlockedPropagationFactorsSize(attr)
    @ccall mlir_c.sdyOpShardingRuleAttrGetBlockedPropagationFactorsSize(attr::MlirAttribute)::Cptrdiff_t
end

function sdyOpShardingRuleAttrGetBlockedPropagationFactorsElem(attr, pos)
    @ccall mlir_c.sdyOpShardingRuleAttrGetBlockedPropagationFactorsElem(attr::MlirAttribute, pos::Cptrdiff_t)::Int64
end
...
function sdyManualAxesAttrGet(ctx, nAxes, axes)
    @ccall mlir_c.sdyManualAxesAttrGet(ctx::MlirContext, nAxes::Cptrdiff_t, axes::Ptr{MlirAttribute})::MlirAttribute
end
...
function sdyManualAxesAttrGetAxesElem(attr, pos)
    @ccall mlir_c.sdyManualAxesAttrGetAxesElem(attr::MlirAttribute, pos::Cptrdiff_t)::MlirStringRef
end
...
function mlirTritonPointerTypeGet(pointeeType, addressSpace)
    @ccall mlir_c.mlirTritonPointerTypeGet(pointeeType::MlirType, addressSpace::Cint)::MlirType
end
...
function mlirTritonInferReduceOpEncoding(operandEncoding, axis)
    @ccall mlir_c.mlirTritonInferReduceOpEncoding(operandEncoding::MlirAttribute, axis::Cint)::MlirAttribute
end
...
function mlirTPUAnalyzePotentialCommunication(op, has_communication, has_custom_barrier)
    @ccall mlir_c.mlirTPUAnalyzePotentialCommunication(op::MlirOperation, has_communication::Ptr{Bool}, has_custom_barrier::Ptr{Bool})::Cvoid
end
...
function mlirTpuVectorLayoutCreate(bitwidth, offsets, tiling, implicit_dim)
    @ccall mlir_c.mlirTpuVectorLayoutCreate(bitwidth::Cint, offsets::MlirTpuLayoutOffsets, tiling::MlirTpuI64TargetTuple, implicit_dim::MlirTpuImplicitDim)::MlirTpuVectorLayout
end
...
function mlirTpuVectorLayoutGetOffsets(layout)
    @ccall mlir_c.mlirTpuVectorLayoutGetOffsets(layout::MlirTpuVectorLayout)::MlirTpuLayoutOffsets
end

function mlirTpuVectorLayoutGetTiling(layout)
    @ccall mlir_c.mlirTpuVectorLayoutGetTiling(layout::MlirTpuVectorLayout)::MlirTpuI64TargetTuple
end

function mlirTpuVectorLayoutGetImplicitDim(layout)
    @ccall mlir_c.mlirTpuVectorLayoutGetImplicitDim(layout::MlirTpuVectorLayout)::MlirTpuImplicitDim
end
...
function mlirTpuVectorLayoutEquals(lhs, rhs)
    @ccall mlir_c.mlirTpuVectorLayoutEquals(lhs::MlirTpuVectorLayout, rhs::MlirTpuVectorLayout)::Bool
end

function mlirTpuVectorLayoutTilesPerVreg(layout, target_shape)
    @ccall mlir_c.mlirTpuVectorLayoutTilesPerVreg(layout::MlirTpuVectorLayout, target_shape::MlirTpuI64TargetTuple)::Int64
end

function mlirTpuVectorLayoutSublanesPerTile(layout, target_shape)
    @ccall mlir_c.mlirTpuVectorLayoutSublanesPerTile(layout::MlirTpuVectorLayout, target_shape::MlirTpuI64TargetTuple)::Int64
end

function mlirTpuVectorLayoutVregSlice(layout, target_shape)
    @ccall mlir_c.mlirTpuVectorLayoutVregSlice(layout::MlirTpuVectorLayout, target_shape::MlirTpuI64TargetTuple)::MlirTpuI64TargetTuple
end

function mlirTpuVectorLayoutImplicitShape(layout, shape)
    @ccall mlir_c.mlirTpuVectorLayoutImplicitShape(layout::MlirTpuVectorLayout, shape::MlirTpuI64ArrayRef)::MlirTpuI64ArrayRef
end

function mlirTpuVectorLayoutTileArrayShape(layout, shape, target_shape)
    @ccall mlir_c.mlirTpuVectorLayoutTileArrayShape(layout::MlirTpuVectorLayout, shape::MlirTpuI64ArrayRef, target_shape::MlirTpuI64TargetTuple)::MlirTpuI64ArrayRef
end

function mlirTpuVectorLayoutTileDataBounds(layout, ctx, full_shape, idxs, size, target_shape, allow_replicated)
    @ccall mlir_c.mlirTpuVectorLayoutTileDataBounds(layout::MlirTpuVectorLayout, ctx::MlirContext, full_shape::Ptr{Int64}, idxs::Ptr{Int64}, size::Csize_t, target_shape::MlirTpuI64TargetTuple, allow_replicated::MlirTpuBoolTargetTuple)::MlirTpuVregDataBounds
end

function mlirTpuVectorLayoutHasNaturalTopology(layout, target_shape)
    @ccall mlir_c.mlirTpuVectorLayoutHasNaturalTopology(layout::MlirTpuVectorLayout, target_shape::MlirTpuI64TargetTuple)::Bool
end

function mlirTpuVectorLayoutHasNativeTiling(layout, target_shape)
    @ccall mlir_c.mlirTpuVectorLayoutHasNativeTiling(layout::MlirTpuVectorLayout, target_shape::MlirTpuI64TargetTuple)::Bool
end

function mlirTpuVectorLayoutGeneralizes(layout, other, shape, target_shape)
    @ccall mlir_c.mlirTpuVectorLayoutGeneralizes(layout::MlirTpuVectorLayout, other::MlirTpuVectorLayout, shape::MlirTpuI64ArrayRef, target_shape::MlirTpuI64TargetTuple)::Bool
end

function mlirTpuVectorLayoutEquivalentTo(layout, other, shape, target_shape)
    @ccall mlir_c.mlirTpuVectorLayoutEquivalentTo(layout::MlirTpuVectorLayout, other::MlirTpuVectorLayout, shape::MlirTpuI64ArrayRef, target_shape::MlirTpuI64TargetTuple)::Bool
end

function mlirTpuVectorLayoutPrint(layout, callback, user_data)
    @ccall mlir_c.mlirTpuVectorLayoutPrint(layout::MlirTpuVectorLayout, callback::MlirStringCallback, user_data::Ptr{Cvoid})::Cvoid
end

function mlirTpuVectorLayoutIsValid(layout, target_shape)
    @ccall mlir_c.mlirTpuVectorLayoutIsValid(layout::MlirTpuVectorLayout, target_shape::MlirTpuI64TargetTuple)::Bool
end
...
function mlirTpuVregDataBoundsMaskVariesAlong(data_bounds, direction, target_shape)
    @ccall mlir_c.mlirTpuVregDataBoundsMaskVariesAlong(data_bounds::MlirTpuVregDataBounds, direction::MlirTpuDirection, target_shape::MlirTpuI64TargetTuple)::Bool
end

function mlirTpuVregDataBoundsIsComplete(data_bounds, target_shape)
    @ccall mlir_c.mlirTpuVregDataBoundsIsComplete(data_bounds::MlirTpuVregDataBounds, target_shape::MlirTpuI64TargetTuple)::Bool
end

function mlirTpuVregDataBoundsGetVectorMask(data_bounds, insertion_point, location, generation, target_shape)
    @ccall mlir_c.mlirTpuVregDataBoundsGetVectorMask(data_bounds::MlirTpuVregDataBounds, insertion_point::MlirTpuInsertionPoint, location::MlirLocation, generation::Cint, target_shape::MlirTpuI64TargetTuple)::MlirValue
end

function mlirTpuVregDataBoundsGetSublaneMask(data_bounds, ctx, target_shape)
    @ccall mlir_c.mlirTpuVregDataBoundsGetSublaneMask(data_bounds::MlirTpuVregDataBounds, ctx::MlirContext, target_shape::MlirTpuI64TargetTuple)::MlirAttribute
end

function mlirTpuAssemble(insertion_point, vector_type, layout, vals, target_shape)
    @ccall mlir_c.mlirTpuAssemble(insertion_point::MlirTpuInsertionPoint, vector_type::MlirType, layout::MlirTpuVectorLayout, vals::MlirTpuValueArray, target_shape::MlirTpuI64TargetTuple)::MlirOperation
end

function mlirTpuDisassemble(insertion_point, layout, val, target_shape)
    @ccall mlir_c.mlirTpuDisassemble(insertion_point::MlirTpuInsertionPoint, layout::MlirTpuVectorLayout, val::MlirValue, target_shape::MlirTpuI64TargetTuple)::MlirTpuValueArray
end

function mlirTpuApplyLayoutOp(ctx, op)
    @ccall mlir_c.mlirTpuApplyLayoutOp(ctx::MlirTpuApplyVectorLayoutContext, op::MlirOperation)::MlirLogicalResult
end

function mlirTpuRelayout(insertion_point, val, src, dst, ctx)
    @ccall mlir_c.mlirTpuRelayout(insertion_point::MlirTpuInsertionPoint, val::MlirValue, src::MlirTpuVectorLayout, dst::MlirTpuVectorLayout, ctx::MlirTpuApplyVectorLayoutContext)::MlirValue
end
...
function mlirMosaicGpuTileTransformAttrGet(ctx, tiling, tiling_size)
    @ccall mlir_c.mlirMosaicGpuTileTransformAttrGet(ctx::MlirContext, tiling::Ptr{Int32}, tiling_size::Int32)::MlirAttribute
end
...
function mlirMosaicGpuTileTransformAttrGetTiling(attr, index)
    @ccall mlir_c.mlirMosaicGpuTileTransformAttrGetTiling(attr::MlirAttribute, index::Int32)::Int32
end
...
function mlirMosaicGpuTransposeTransformAttrGet(ctx, permutation, permutation_size)
    @ccall mlir_c.mlirMosaicGpuTransposeTransformAttrGet(ctx::MlirContext, permutation::Ptr{Int32}, permutation_size::Int32)::MlirAttribute
end

function mlirMosaicGpuTransposeTransformAttrGetPermutationSize(attr)
    @ccall mlir_c.mlirMosaicGpuTransposeTransformAttrGetPermutationSize(attr::MlirAttribute)::Int32
end

function mlirMosaicGpuTransposeTransformAttrGetPermutation(attr, index)
    @ccall mlir_c.mlirMosaicGpuTransposeTransformAttrGetPermutation(attr::MlirAttribute, index::Int32)::Int32
end
...
function mlirMosaicGpuSwizzleTransformAttrGet(ctx, swizzle)
    @ccall mlir_c.mlirMosaicGpuSwizzleTransformAttrGet(ctx::MlirContext, swizzle::Int32)::MlirAttribute
end
...
function enzymexlaLapackLayoutAttrGet(ctx, col_major)
    @ccall mlir_c.enzymexlaLapackLayoutAttrGet(ctx::MlirContext, col_major::UInt8)::MlirAttribute
end

function enzymexlaLapackTransposeAttrGet(ctx, mode)
    @ccall mlir_c.enzymexlaLapackTransposeAttrGet(ctx::MlirContext, mode::Int32)::MlirAttribute
end

function enzymexlaLapackSideAttrGet(ctx, left_side)
    @ccall mlir_c.enzymexlaLapackSideAttrGet(ctx::MlirContext, left_side::UInt8)::MlirAttribute
end
...
function enzymexlaGeluApproximationAttrGet(ctx, mode)
    @ccall mlir_c.enzymexlaGeluApproximationAttrGet(ctx::MlirContext, mode::Int32)::MlirAttribute
end
